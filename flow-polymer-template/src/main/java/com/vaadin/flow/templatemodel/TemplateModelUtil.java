...
public final class TemplateModelUtil {
    ...
    /**
     * Resolves a bean model type and model map based on a model instance and passes those values to the provided
     * callback.
     *
     * @param <R>
     *            the return type
     * @param model
     *            the model instance for which to resolve a type and a map, not <code>null</code>
     * @param modelPath
     *            the model path to resolve, not <code>null</code>
     * @param callback
     *            the callback to run with the resolved bean type and the model map, not <code>null</code>
     ...
     *            the return type
     * @param model
     *            the model instance for which to resolve a type and a list, not <code>null</code>
     * @param modelPath
     *            the model path to resolve, not <code>null</code>
     * @param callback
     *            the callback to run with the resolved list type and model list, not <code>null</code>
     * @return the value returned by the callback
     */
    ...
    /**
     * Gets a filter based on any <code>@Include</code> and/or <code>@Exclude</code> annotations present on the given
     * method.
     *
     * @param method
     *            the method to check
