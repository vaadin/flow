...
public enum ClientUpdateMode {
    ...
    DENY,
    /**
     * Allow updating the property if there is a corresponding two-way binding in the template. This is the default mode
     * that is used if nothing else has been defined for a property.
     */
    IF_TWO_WAY_BINDING;
}
