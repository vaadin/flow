...
class DevModeBrowserLauncherVaadinAndServletMappingTest
        extends AbstractDevModeBrowserLauncherTest {

    @Test
    void getUrl_withContextPathAndUrlMapping_givesUrlWithContextPathAndUrlMapping() {
        MockServletContext ctx = (MockServletContext) app.getServletContext();
        ctx.setContextPath("/contextpath");
        String url = DevModeBrowserLauncher.getUrl(app);
        assertEquals("http://localhost:1234/contextpath/ui/", url);
    }
