...
public class TestDataGenerator {
    ...
    public static String getPhoneNumber(Random r) {
        return "+358 02 555 " + r.nextInt(10) + r.nextInt(10) + r.nextInt(10) + r.nextInt(10);
    }
    ...
    public static Date getBirthDate(Random r) {
        Calendar c = Calendar.getInstance(TimeZone.getTimeZone("EET"), new Locale("FI", "fi"));
        c.setLenient(true);
        c.setTimeInMillis(0);
