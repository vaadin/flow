...
public class SimpleJavaScriptExtensionTest extends AbstractTestUI {
    ...
    public static class SimpleJavaScriptExtensionState extends JavaScriptExtensionState {
    ...
    public static interface SimpleJavaScriptExtensionClientRpc extends ClientRpc {
        public void greet(String message);
    }

    public static interface SimpleJavaScriptExtensionServerRpc extends ServerRpc {
        public void greet(String message);
    }

    @JavaScript("/statictestfiles/jsextension.js")
    @StyleSheet("/VAADIN/external1.css")
    public static class SimpleJavascriptExtension extends AbstractJavaScriptExtension {
        ...
        public void greetRpc(String message) {
            getRpcProxy(SimpleJavaScriptExtensionClientRpc.class).greet(message);
        }
