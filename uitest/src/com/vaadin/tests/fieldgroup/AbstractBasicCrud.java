...
public abstract class AbstractBasicCrud extends AbstractTestUIWithLog {
    ...
    protected static String[] columns = new String[] { "firstName", "lastName", "gender", "birthDate", "age", "alive", "address.streetAddress", "address.postalCode", "address.city", "address.country" };
    protected BeanItemContainer<ComplexPerson> container = ComplexPerson.createContainer(100);;
    {
    ...
    protected void setup(VaadinRequest request) {
        ...
        formType.setItemCaption(iterator.next(), "Auto generated form (TextFields)");
        formType.setItemCaption(iterator.next(), "Auto generated form (Any fields)");
    ...
    public class CustomForm extends AbstractForm {
        ...
        private TextField address_streetAddress = new TextField("Street address");
    ...
    public class AbstractForm extends GridLayout {
        ...
        protected BeanFieldGroup<ComplexPerson> fieldGroup = new BeanFieldGroup<ComplexPerson>(ComplexPerson.class) {
            @Override
