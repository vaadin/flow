...
public class FieldBinderWithBeanValidation extends TestBase {
    ...
    protected void setup() {
        ...
        final BeanFieldGroup<PersonWithBeanValidationAnnotations> fieldGroup = new BeanFieldGroup<PersonWithBeanValidationAnnotations>(PersonWithBeanValidationAnnotations.class);
    ...
    public static PersonWithBeanValidationAnnotations getPerson(FieldGroup binder) {
        return ((BeanItem<PersonWithBeanValidationAnnotations>) binder.getItemDataSource()).getBean();
    }
