...
public class DeploymentConfigurationTest extends MultiBrowserTest {
    ...
    public void testParameters() {
        openTestURL();
        List<String> texts = new ArrayList<String>(Arrays.asList("Init parameters:", "legacyPropertyToString: false", "closeIdleSessions: true", "productionMode: false", "testParam: 42", "heartbeatInterval: 301", "resourceCacheTime: 3601"));
