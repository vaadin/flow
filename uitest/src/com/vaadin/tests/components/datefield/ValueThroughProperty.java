...
public class ValueThroughProperty extends TestBase {
    private final Property<Date> dateProperty = new ObjectProperty<Date>(null, Date.class);
    ...
    protected String getTestDescription() {
        return "Setting a value through a property should update the" + " client-side even if it contains an invalid value.";
    }
