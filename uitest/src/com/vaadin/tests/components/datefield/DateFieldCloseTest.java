...
public class DateFieldCloseTest extends MultiBrowserTest {
    ...
    private void checkForCalendarHeader(boolean headerShouldExist) {
        boolean headerExists = isElementPresent(By.className("v-datefield-calendarpanel-header"));
    ...
    private void clickButton() {
        WebElement dateFieldButton = dateField.findElement(By.className("v-datefield-button"));
