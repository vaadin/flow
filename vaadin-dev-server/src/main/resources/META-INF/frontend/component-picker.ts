...
function shimMove(targetElement: HTMLElement, _e: MouseEvent) {
  ...
  // const currentlySelected = currentComponents[selectedComponentIndex];
  const selected = components.length - 1;
  // if (currentlySelected) {
  //   selected = components.findIndex(
  //     (component) => component.appId === currentlySelected.appId && component.nodeId === currentlySelected.nodeId
  //   );
  //   if (selected < 0) {
  //     selected = 0;
  //   }
