...
class JsonHelpers {
         ...
         * @return Json {@link ObjectNode} if found or null. Always returns a node if <code>createNew</code> is <code>true</code> and <code>arrayNode</code> is not null.
         */
        static ObjectNode findById(String pid, JsonNode arrayNode, String idField, boolean createNew) {
