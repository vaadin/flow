 ...
 */
public final class Webpack5Handler extends AbstractDevServerRunner {
    ...
    private static final String DEFAULT_OUTPUT_PATTERN = "webpack.* compiled .*";
    private static final String DEFAULT_ERROR_PATTERN = "webpack.* compiled with .* error";
     ...
     */
    public Webpack5Handler(Lookup lookup, int runningPort, File npmFolder,
