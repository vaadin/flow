...
public class OpenInCurrentIdeTest {
    ...
    public void ideaOnMacDetected() throws IOException {
        ...
        processes
                .add(mock(cmd1.replace(baseDirInCommands, baseDir), replaceInArray(args1, baseDirInCommands, baseDir)));
        processes
                .add(mock(cmd2.replace(baseDirInCommands, baseDir), replaceInArray(args2, baseDirInCommands, baseDir)));
        ...
        Assert.assertEquals(new File(baseDirectory, "MacOS/idea").getAbsolutePath(),
                new File(OpenInCurrentIde.getBinary(ideCommand.get())).getAbsolutePath());
    ...
    public void ideaOnLinuxDetected() throws IOException {
        ...
        Assert.assertEquals(new File(baseDirectory, "bin/idea").getAbsolutePath(),
    ...
    public void ideaOnLinuxDebugModeDetected() throws IOException {
        ...
        String cmd1 = "/home/somebody/.sdkman/candidates/java/17.0.5-tem/bin/java";
        String[] args1 = new String[] { "-agentlib:jdwp=transport=dt_socket,address=127.0.0.1:46225,suspend=y,server=n",
        ...
        Info info1 = mock(cmd1.replace(baseDirInCommands, baseDir), replaceInArray(args1, baseDirInCommands, baseDir));
    ...
    private File setupIntelliJDirectory(boolean mac, String binaryFilename) throws IOException {
    ...
    private String[] replaceInArray(String[] args, String find, String replace) {
    ...
    public void vsCodeOnMacDetected() {
        ...
        String[] args3 = new String[] { "--ms-enable-electron-run-as-node",
                "/Applications/Visual Studio Code.app/Contents/Resources/app/out/bootstrap-fork", "--type=ptyHost",
                "--logsPath", "/Users/somebody/Library/Application Support/Code/logs/20221225T212012", };
        ...
        String[] args4 = new String[] { "--type=renderer",
                ...
                "--standard-schemes=vscode-webview,vscode-file", "--secure-schemes=vscode-webview,vscode-file",
                "--bypasscsp-schemes", "--cors-schemes=vscode-webview,vscode-file",
                "--fetch-schemes=vscode-webview,vscode-file", "--service-worker-schemes=vscode-webview",
                "--streaming-schemes", "--app-path=/Applications/Visual Studio Code.app/Contents/Resources/app",
                "--no-sandbox", "--no-zygote", "--node-integration-in-worker", "--lang=en-GB", "--num-raster-threads=4",
                "--enable-zero-copy", "--enable-gpu-memory-buffer-compositor-resources",
                "--enable-main-frame-before-activation", "--renderer-client-id=20", "--launch-time-ticks=444960654929",
                "--shared-files", "--field-trial-handle=1718379636,r,11433658063312687633,15858774526786421505,131072",
    ...
    public void vsCodeOnWindowsDetected() {
        ...
        // THe binary is not used for VSCode
        Assert.assertEquals("C:\\Users\\Somebody\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe",
                OpenInCurrentIde.getBinary(ideCommand.get()));
    ...
    public void vsCodeOnLinuxDetected() {
        ...
        String[] args2 = new String[] { "-classpath",
                ...
                "org.codehaus.plexus.classworlds.launcher.Launcher", "-Dexec.vmArgs=-Dfile.encoding=UTF-8",
                "-Dexec.args=${exec.vmArgs} -classpath %classpath ${exec.mainClass} ${exec.appArgs}",
                "-Dexec.executable=/usr/lib/jvm/java-17/bin/java",
                "-Dexec.mainClass=com.example.application.Application", "-Dexec.classpathScope=runtime",
                "-Dexec.appArgs=",
        ...
        String[] args5 = new String[] { "--ms-enable-electron-run-as-node", "--inspect-port=0",
    ...
    public void eclipseOnWindowsDetected() throws IOException {
        ...
        Assert.assertEquals("C:\\Users\\Somebody\\eclipse\\java-2022-06\\eclipse\\eclipse.exe",
                OpenInCurrentIde.getBinary(ideCommand.get()));
    }

    @Test
    public void eclipseOnMacDetected() {
        String[] arguments = new String[] { "-Dfile.encoding=UTF-8", "-classpath",
                ...
                "-XX:+ShowCodeDetailsInExceptionMessages", "com.vaadin.base.devserver.OpenInCurrentIde" };
        Info info1 = mock("/Library/Java/JavaVirtualMachines/jdk-17.0.1.jdk/Contents/Home/bin/java", arguments);

        String[] arguments2 = new String[] { "-data", "file:/some/folder/to/workspace/", "-os", "macosx", "-ws",
                ...
                "-launcher", "/eclipse/install/dir/Eclipse.app/Contents/MacOS/eclipse", "-name", "Eclipse",
                "--launcher.library",
                ...
                "--launcher.appendVmargs", "-product", "org.eclipse.epp.package.jee.product", "-keyring",
                ...
                "-vmargs", "-Dosgi.requiredJavaVersion=17", "-Dosgi.instance.area.default=@user.home/eclipse-workspace",
                "-Dsun.java.command=Eclipse", "-XX:+UseG1GC", "-XX:+UseStringDeduplication", "--add-modules=ALL-SYSTEM",
                "-XstartOnFirstThread", "-Dorg.eclipse.swt.internal.carbon.smallFonts", "-Dosgi.requiredJavaVersion=11",
                "-Dosgi.dataAreaRequiresExplicitInit=true",
                "-Dorg.eclipse.swt.graphics.Resource.reportNonDisposed=true", "-Xms256m", "-Xmx2048m",
                "--add-modules=ALL-SYSTEM", "-Xdock:icon=../Resources/Eclipse.icns", "-XstartOnFirstThread",
                "-Dorg.eclipse.swt.internal.carbon.smallFonts", "-Declipse.p2.max.threads=10",
                "-Doomph.update.url=https://download.eclipse.org/oomph/updates/milestone/latest",
                "-Doomph.redirection.index.redirection=index:/->http://git.eclipse.org/c/oomph/org.eclipse.oomph.git/plain/setups/" };

        Info info2 = mock("/eclipse/install/dir/Eclipse.app/Contents/MacOS/eclipse", arguments2);
        ...
        // THe binary is not used for VSCode
        Assert.assertEquals("/eclipse/install/dir/Eclipse.app", OpenInCurrentIde.getBinary(ideCommand.get()));
    ...
    public void eclipseOnLinuxDetected() {
        ...
        String[] args1 = new String[] { "-Dfile.encoding=UTF-8", "-classpath",
                ...
                "-XX:+ShowCodeDetailsInExceptionMessages", "com.example.application.Application", };

        String cmd2 = "/usr/lib/jvm/java-17-openjdk-arm64/bin/java";
        String[] args2 = new String[] { "-Dosgi.requiredJavaVersion=17",
                "-Dosgi.instance.area.default=@user.home/eclipse-workspace", "-Dosgi.dataAreaRequiresExplicitInit=true",
                "-Dorg.eclipse.swt.graphics.Resource.reportNonDisposed=true", "-Dsun.java.command=Eclipse", "-Xms256m",
                "-Xmx2048m", "-XX:+UseG1GC", "-XX:+UseStringDeduplication", "--add-modules=ALL-SYSTEM",
                ...
                "-launcher", "/home/somebody/eclipse/jee-2022-12/eclipse/eclipse", "-name", "Eclipse",
                "--launcher.library",
                "/home/somebody/.p2/pool/plugins/org.eclipse.equinox.launcher.gtk.linux.aarch64_1.2.700.v20221108-1024/eclipse_11801.so",
                "-startup",
                "/home/somebody/eclipse/jee-2022-12/eclipse//plugins/org.eclipse.equinox.launcher_1.6.400.v20210924-0641.jar",
                "--launcher.appendVmargs", "-exitdata", "8004", "-product", "org.eclipse.epp.package.jee.product",
                "-vm", "/usr/lib/jvm/java-17-openjdk-arm64/bin/java", "-vmargs", "-Dosgi.requiredJavaVersion=17",
                "-Dosgi.instance.area.default=@user.home/eclipse-workspace", "-Dosgi.dataAreaRequiresExplicitInit=true",
                "-Dorg.eclipse.swt.graphics.Resource.reportNonDisposed=true", "-Dsun.java.command=Eclipse", "-Xms256m",
                "-Xmx2048m", "-XX:+UseG1GC", "-XX:+UseStringDeduplication", "--add-modules=ALL-SYSTEM",
                "-Declipse.p2.max.threads=10",
        ...
        String[] args3 = new String[] { "-vm", "/usr/lib/jvm/java-17-openjdk-arm64/bin", "-vmargs",
        ...
        // THe binary is not used for VSCode
        Assert.assertEquals("/home/somebody/eclipse/jee-2022-12/eclipse/eclipse",
                OpenInCurrentIde.getBinary(ideCommand.get()));
    ...
    public void runFromCommandLineWorks() {
        ...
        String[] args1 = new String[] { "-XX:TieredStopAtLevel=1", "-Xdebug",
                "-Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5731", "-cp", "lotsofjars.jar",
                "com.example.application.Application", };
    ...
    private Info mock(String cmd, String[] arguments) {
        ...
        Mockito.when(info.arguments()).thenReturn(Optional.ofNullable(arguments));
        if (cmd != null && arguments != null) {
            Mockito.when(info.commandLine()).thenReturn(Optional.of(cmd + " " + String.join(" ", arguments)));
        }
    ...
    public void runThrowsExceptionOnFailure() throws InterruptedException {
        ...
        try {
            OpenInCurrentIde.run("/bin/sh", "-c", "echo 'output1'; echo 'output2'; exit 123");
            Assert.fail("Should have thrown exception");
        } catch (IOException e) {
            Assert.assertTrue("Exit code should have been reported",
                    e.getMessage().contains("terminated with exit code 123"));
            Assert.assertTrue("Output should have been included", e.getMessage().contains("output1"));
            Assert.assertTrue("Output should have been included", e.getMessage().contains("output2"));
        }
    }
}
