 ...
 * the License.
 */
package com.vaadin.hummingbird.linker;
 ...
 * version of the single script template. This is because the one from
 * {@link SingleScriptLinker} does a <code>document.write</code> which means it
 * cannot be used deferred.
 *
...
public class ClientEngineLinker extends SingleScriptLinker {
    ...
    private static final String SINGLE_SCRIPT_TEMPLATE_JS = "com/vaadin/hummingbird/linker/ClientEngineSingleScriptTemplate.js";
    private static final String COMPUTE_SCRIPT_BASE_DOT_JS = "com/google/gwt/core/ext/linker/impl/computeScriptBase.js";

    @Override
    public String getDescription() {
        return "Hummingbird Custom Single Script Linker";
    }
