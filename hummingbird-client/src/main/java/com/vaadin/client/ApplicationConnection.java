...
/**
 * Main class for an application / UI. Handles starting the application.
 */
public class ApplicationConnection {
    ...
    public ApplicationConnection(
        ...
        registry = new Registry(this, applicationConfiguration);
        ...
        Console.log("Starting application "
                + applicationConfiguration.getRootPanelId());
        ...
        String appRootPanelName = applicationConfiguration.getRootPanelId();
