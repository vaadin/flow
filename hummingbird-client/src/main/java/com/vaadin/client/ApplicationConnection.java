...
public class ApplicationConnection {
    ...
    public ApplicationConnection(
        ...
        Console.log("Starting application " + configuration.getRootPanelId());
    ...
    private boolean isExecutingDeferredCommands() {
        ...
        if (s instanceof SchedulerImpl) {
            return ((SchedulerImpl) s).hasWorkQueued();
        } else {
            return false;
        }
    }
