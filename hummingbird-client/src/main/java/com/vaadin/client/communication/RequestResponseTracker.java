...
public class RequestResponseTracker {
    ...
    /**
     * Checks is there is an active UIDL requests.
     *
    ...
    public void endRequest() {
        ...
        Scheduler.get().scheduleDeferred(() -> {
            ...
            boolean activeRequest = hasActiveRequest();
            boolean rpcFlushPending = registry.getServerRpcQueue()
                    .isFlushPending();

            if (terminated || activeRequest || rpcFlushPending) {
