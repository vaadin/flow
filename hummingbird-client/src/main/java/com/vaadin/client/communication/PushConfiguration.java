...
public class PushConfiguration {
     ...
     */
    public void onPushModeChange(MapPropertyChangeEvent event) {
    ...
    public String getPushUrl() {
        if (getConfigurationNamespace()
                .hasProperty(PushConfigurationMap.PUSH_URL_KEY)) {
    ...
    public boolean isAlwaysXhrToServer() {
        return getConfigurationNamespace()
                .hasProperty(PushConfigurationMap.ALWAYS_USE_XHR_TO_SERVER);
    }
    ...
    private boolean isPushEnabled(Object propertyValue) {
        if (propertyValue == null) {
            return false;
        }

        String pushMode = (String) propertyValue;
        return !pushMode.equals("DISABLED");
    }
