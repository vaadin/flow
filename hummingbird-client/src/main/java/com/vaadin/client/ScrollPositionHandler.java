...
public class ScrollPositionHandler {
     ...
     * state event is inside page navigation (fragment change).
     *
     * @param event
     *            the pop state event
    ...
    private void storeCurrentScrollPosition() {
        Integer scrollY = Browser.getWindow().getScrollY();
        yPositions.set(currentHistoryPosition, scrollY.doubleValue());

        Integer scrollX = Browser.getWindow().getScrollX();
        xPositions.set(currentHistoryPosition, scrollX.doubleValue());
    }
