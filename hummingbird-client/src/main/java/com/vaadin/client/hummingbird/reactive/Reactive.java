...
/**
 * Handles global features related to reactivity.
 *
 * @since
 * @author Vaadin Ltd
 */
public class Reactive {
    ...
    /**
     * Flushes all added flush listeners.
     *
     ...
     * {@link #getCurrentComputation()}. The previous current computation is
     * restored after the task has run.
     *
     * @param computation
