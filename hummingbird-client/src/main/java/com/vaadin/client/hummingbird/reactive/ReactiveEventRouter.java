 ...
 * type as well dependent on the generic value change. All events are fired to
...
public abstract class ReactiveEventRouter<L, E extends ReactiveValueChangeEvent> {
     ...
     * {@link #addListener(Object)} or {@link #addReactiveListener(ReactiveValueChangeListener)}
     * as well as all global event collectors added using
     * {@link Reactive#addEventCollector(ReactiveValueChangeListener)}.
     *
     * @param event
     *            the event to fire
