 ...
 * 's DOM API</a>.
 * <p>
 * Contains methods for checking whether polymer-micro.html and polymer.html
 * have been loaded.
 *
 * @author Vaadin Ltd
 */
public class PolymerDomApiImpl implements DomApiImpl {
    ...
    /**
     * Checks whether the polymer.html has been loaded or not.
     *
     * @return <code>true</code> if polymer has been fully loaded,
     *         <code>false</code> if not
     */
    public static boolean isPolymerFullyLoaded() {
        Polymer polymer = getPolymer();
        return polymer != null && polymer.getUpdateStyles() != null;
    }

    /**
     * A reference to the native Polymer.updateStyles method in JavaScript.
     */
    @JsType(isNative = true)
    interface UpdateStyles {
    ...
    interface Polymer {
        ...
        /**
         * Returns a reference to the native <code>Polymer.updateStyles</code>
         * function.
         * <p>
         * The existence of this function can be used to check whether Polymer
         * has been fully loaded.
         *
         * @return the update styles function, or <code>null</code> if polymer
         *         has not been fully loaded
         */
        @JsProperty
        UpdateStyles getUpdateStyles();
