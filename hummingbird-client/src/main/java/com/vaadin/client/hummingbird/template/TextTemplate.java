...
/**
 * Client-side representation of a {@link TextTemplateNode} received from the
 * server. The properties are based on the output of
 * {@link TextTemplateNode#populateJson(JsonObject)}.
 *
 * @since
 * @author Vaadin Ltd
 */
...
public interface TextTemplate extends Template {
     ...
     */
    @JsProperty(name = TextTemplateNode.BINDING_KEY)
