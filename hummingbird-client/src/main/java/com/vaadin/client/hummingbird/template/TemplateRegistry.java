...
public class TemplateRegistry {
    ...
    private final JsMap<Double, Template> instanceMap = JsCollections.map();
     ...
     */
    public void register(int id, Template template) {
    ...
    public Template get(int id) {
        Template template = instanceMap.get(Double.valueOf(id));
