...
public class BasicElementBinder {
    ...
    private EventRemover bindListeners() {
        ...
        listeners.forEachProperty((property, name) -> {
            bindEventHandlerProperty(property);
        });
    ...
    private void bindEventHandlerProperty(MapProperty property) {
        ...
        Computation computation = new Computation() {
            ...
            protected void doRecompute() {
                ...
                boolean hasValue = property.hasValue();
    ...
    private void addEventHandler(String eventType) {
        ...
        EventRemover remover = element.addEventListener(eventType, e -> {
            node.getTree().sendEventToServer(node, e);
        } , false);
