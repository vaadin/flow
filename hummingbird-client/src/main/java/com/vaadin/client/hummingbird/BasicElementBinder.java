...
public class BasicElementBinder {
    ...
    private void updateProperty(MapProperty property) {
        String name = property.getName();

        if (property.hasValue()) {
            WidgetUtil.setJsProperty(element, name, property.getValue());
    ...
    private void updateAttribute(MapProperty property) {
        String name = property.getName();

        if (property.hasValue()) {
            element.setAttribute(name, String.valueOf(property.getValue()));
        } else {
