...
public class ClientJsonCodecTest {
    @Test
    public void decodeSimpleType() {
        decodePrimitiveValues(ClientJsonCodec::decodeBasicValue);
    }
    ...
    public void testDecodeSimpleType_arrayUnsupported() {
        ClientJsonCodec.decodeBasicValue(Json.createArray());
    }

    @Test(expected = IllegalArgumentException.class)
    public void testDecodeSimpleType_objectUnsupported() {
        ClientJsonCodec.decodeBasicValue(Json.createObject());
    }

    @Test
    public void decodeComplexType_primitives() {
        decodePrimitiveValues(
                json -> ClientJsonCodec.decodeComplexValue(null, json));
    }

    @Test
    public void decodeComplexType_array() {
        JsonValue json = JsonCodec.encodeComplexValue(
                JsonUtil.createArray(Json.create("string"), Json.create(true)));

        Object decoded = ClientJsonCodec.decodeComplexValue(null, json);
    ...
    @Test
    public void decodeCoimplexType_element() {
        ...
        Object decoded = ClientJsonCodec.decodeComplexValue(tree, json);
