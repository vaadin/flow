...
public class ReconnectDialogConfigurationTest extends AbstractMapNamespaceTest {
    ...
    public void reactsToChanges() {
        verifyReactsToChanges(RECONNECT_INTERVAL_KEY, 12);
        verifyReactsToChanges(RECONNECT_ATTEMPTS_KEY, 12);
        verifyReactsToChanges(DIALOG_GRACE_PERIOD_KEY, 12);
        verifyReactsToChanges(DIALOG_MODAL_KEY, true);
        verifyReactsToChanges(DIALOG_TEXT_KEY, "foobar");
        verifyReactsToChanges(DIALOG_TEXT_GAVE_UP_KEY, "foobar");
    }
    ...
    private void verifyReactsToChanges(String key, Object value) {
        configurationUpdatedCalled.set(0);
