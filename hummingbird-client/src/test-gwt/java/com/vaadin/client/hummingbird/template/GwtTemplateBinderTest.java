...
public class GwtTemplateBinderTest extends ClientEngineTestBase {
    ...
    public void testTemplateAttributes() {
        TestElementTemplate template = TestElementTemplate.create("div");
        template.addAttribute("attr1", "value1");
        template.addAttribute("attr2", "value2");
    ...
    public void testTemplateChildren() {
        ...
        TestElementTemplate childTemplate = TestElementTemplate.create("span");
        registry.getTemplates().addTemplate(childId, childTemplate);

        TestElementTemplate parentTemplate = TestElementTemplate.create("div");
    ...
    public void testRegisteredTemplate() {
        ...
        TestElementTemplate template = TestElementTemplate.create("div");
        registry.getTemplates().addTemplate(templateId, template);
