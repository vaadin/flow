...
public class GwtTemplateBinderTest extends ClientEngineTestBase {
    ...
    public void testTemplateAttributes() {
        TestElementTemplate testTemplate = new TestElementTemplate("div");
        testTemplate.addAttribute("attr1", "value1");
        testTemplate.addAttribute("attr2", "value2");

        Element element = (Element) TemplateElementBinder
                .createAndBind(stateNode, testTemplate.asTemplate());
    ...
    public void testTemplateChildren() {
        ...
        TestElementTemplate childTemplate = new TestElementTemplate("span");
        registry.getTemplates().addTemplate(childId,
                childTemplate.asTemplate());

        TestElementTemplate parentTemplate = new TestElementTemplate("div");
        parentTemplate.children = new double[] { childId };

        Element element = (Element) TemplateElementBinder
                .createAndBind(stateNode, parentTemplate.asTemplate());
    ...
    public void testTemplateText() {
        TestTextTemplate testTemplate = new TestTextTemplate(
                new TestStaticBinding("text"));
        Node domNode = TemplateElementBinder.createAndBind(stateNode,
                testTemplate.asTemplate());
    ...
    public void testRegisteredTemplate() {
        ...
        TestElementTemplate testTemplate = new TestElementTemplate("div");
        registry.getTemplates().addTemplate(templateId,
                testTemplate.asTemplate());
