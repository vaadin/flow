...
public class GwtRouterLinkHandlerTest extends ClientEngineTestBase {
    ...
    private JsArray<JsonValue> invocations;

    private MouseEvent currentEvent;

    private ServerRpcQueue rpcQueue = new ServerRpcQueue(null) {
        @Override
    ...
    protected void gwtSetUp() throws Exception {
        ...
        RouterLinkHandler.bind(rpcQueue, Browser.getDocument().getBody());
    }
