...
public class ParameterView extends Div implements HasUrlParameter<String> {
    ...
    public ParameterView() {
        ...
        RouterLink fooLink = new RouterLink("Navigate with parameter 'foo'", ParameterView.class, "foo");
        fooLink.setId("fooLink");
        add(fooLink);
        add(new Div());
        RouterLink barLink = new RouterLink("Navigate with parameter 'bar'", ParameterView.class, "bar");
        barLink.setId("barLink");
        add(barLink);

        parameters = new Div();
        parameters.setId("parameters");
        parameters.getStyle().setWhiteSpace(com.vaadin.flow.dom.Style.WhiteSpace.PRE);
        add(parameters);
