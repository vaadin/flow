...
/**
 * Replaces the non-existing stylesheet of {@link DependencyFilterView} with one
 * that exists, so that the test can verify that a
 * {@link com.vaadin.flow.server.DependencyFilter} is applied.
 */
@Component
public class DependencyFilterInitListener implements VaadinServiceInitListener {
