...
public class DevModeNoClassCacheView extends Div {
    ...
    public DevModeNoClassCacheView() {
        ...
        try {
            ...
            add(new Span("valid resource count:" + (validResources == null ? "0" : validResources.size())));
            ...
            add(new Span("skipped resource count:" + (skippedResources == null ? "0" : skippedResources.size())));
            ...
            add(new Span("dynamic white list count:" + (dynamicWhiteList == null ? "0" : dynamicWhiteList.size())));
            ...
            Span span = new Span("route packages count:" + (routePackages == null ? "0" : routePackages.size()));
