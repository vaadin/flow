 ...
 * <p>
 * Run by every fixture. A pom is a pom whoever launches the application, and
 * the runtime that re-reads it on the way back up is the one with the most to
 * get wrong: under a build plugin the restart is a Maven invocation against the
 * very file that was just edited.
 */
