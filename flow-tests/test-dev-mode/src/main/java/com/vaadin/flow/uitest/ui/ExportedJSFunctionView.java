...
public class ExportedJSFunctionView extends AbstractDivView {
    ...
    protected void onShow() {
        ...
        String versionJs = "var msg = '';" + "var versionInfoMethod = " + client + ".getVersionInfo;"
                + "if (versionInfoMethod) {" + "  msg += 'version: '+versionInfoMethod().flow;" + "} else {" //
        ...
        getPage().executeJs("$0.addEventListener('click', function() {" + client + ".poll();" //
                + "});", div);
        add(div);
