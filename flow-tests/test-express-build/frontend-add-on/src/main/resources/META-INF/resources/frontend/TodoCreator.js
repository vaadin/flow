    ...
    render() {
        return html`
            <div id="todoEntry">
                ...
                <input type="text" @change=${this.updateTask} id="task-input"
                       style="width: 25%; display: inline-block"/>
                <label for="user-name-input">Username</label>
                <input type="text" @change=${this.updateName} char-counter maxlength="16"
                             error="maximum characters exceeded" id="user-name-input"
                             style="width: 25%; display: inline-block"/>
