...
public class ThemeReloadIT extends ViteDevModeIT {
    ...
    public void updateStyle_changeIsReloaded() throws IOException {
        ...
        File themeFolder = new File(baseDir, FrontendUtils.DEFAULT_FRONTEND_DIR + "themes/vite-basics/");
        ...
        try {
            ...
            waitUntil(webDriver -> webDriver.findElement(By.tagName("h2")).getCssValue("color")
                    .equals("rgba(255, 0, 0, 1)"), 30);
            header = $("h2").first();
