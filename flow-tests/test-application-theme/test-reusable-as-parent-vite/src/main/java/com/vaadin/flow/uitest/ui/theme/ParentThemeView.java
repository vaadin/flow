...
@Route("com.vaadin.flow.uitest.ui.theme.ParentThemeView")
public class ParentThemeView extends Div {
    ...
    public ParentThemeView() {
        ...
        add(textSpan, snowFlake, subCss, butterfly, octopuss, faText, keyboardIconFromParentTheme,
                lemonIconFromParentTheme, sunIconFromParentTheme);
