...
public class CssLoadingIT extends ChromeBrowserTest {
    ...
    /**
     * Regression for https://github.com/vaadin/flow/issues/24164.
     * <p>
     * {@code relurl-test/styles.css} imports {@code views/messages.css}, which
     * uses {@code background-image: url('../images/dot.svg')}. In production
     * the build inlines the import; without URL rewriting the browser would
     * resolve the relative URL against the entry file (the wrong folder) and
     * 404. The expected resolved URL is therefore
     * {@code /relurl-test/images/dot.svg}, regardless of dev vs production
     * mode.
     */
    @Test
