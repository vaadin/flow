...
public class Activator {
    ...
    private static final class CustomContextHelper extends ServletContextHelper {
    ...
    private static class CustomContextHelperFactory implements ServiceFactory<ServletContextHelper> {
    ...
    private static class FixedLogoutWithNotificationServlet extends LogoutWithNotificationServlet {
        @Override
        public void init(ServletConfig servletConfig) throws ServletException {
            super.init(servletConfig);
    ...
    void activate() throws NamespaceException {
        ...
        context.registerService(Servlet.class, new FixedLogoutWithNotificationServlet(),
                createProperties("/logout-with-notification/*", false));

        context.registerService(Servlet.class, new FixedRouterLayoutCustomScopeServlet(),
    ...
    private void registerPlainJsResource(BundleContext context) {
        ...
        properties.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_RESOURCE_PATTERN, "/plain-script.js");
        properties.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_RESOURCE_PREFIX, "/osgi-web-resources/plain-script.js");
        context.registerService(OsgiResourceRegistration.class, new OsgiResourceRegistration(), properties);
    }
    ...
    private String registerCustomContext(BundleContext context) {
        ...
        contextProps.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_CONTEXT_NAME, contextName);
        contextProps.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_CONTEXT_PATH, "/custom-test-context");
        context.registerService(ServletContextHelper.class, new CustomContextHelperFactory(), contextProps);
        return contextName;
    }

    private void registerCustomContextServlet(BundleContext context, String contextName) {
        Hashtable<String, Object> properties = createProperties("/view/*", false);
        ...
        context.registerService(Servlet.class, new FixedViewServlet(), properties);
    }

    private Hashtable<String, Object> createProperties(String mapping, Boolean isProductionMode) {
        Hashtable<String, Object> properties = new Hashtable<>();
        properties.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_CONTEXT_INIT_PARAM_PREFIX
                + InitParameters.SERVLET_PARAMETER_PRODUCTION_MODE, isProductionMode.toString());
        properties.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_SERVLET_ASYNC_SUPPORTED, true);
        properties.put(HttpWhiteboardConstants.HTTP_WHITEBOARD_SERVLET_PATTERN, mapping);
        return properties;
    }
