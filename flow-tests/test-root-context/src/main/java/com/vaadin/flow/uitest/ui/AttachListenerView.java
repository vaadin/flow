...
/**
 * View for testing DOM changes inside attach listeners, based on https://github.com/vaadin/flow/issues/4209
 *
 * @since 1.0
 */
...
public class AttachListenerView extends AbstractDivView {
    ...
    public AttachListenerView() {
        ...
        /*
         * The tests consists in creating permutations of components being added to themselves, and some components
         * listening to the attach events. Initially all components are added to the result Div, and the attach event
         * generated by that is treated according to the selected options.
         *
         * The structure of the result Div is then changed by the attach listener, and evaluated by the integration
         * tests.
         */
    ...
    private void configureAttachPermutation(Span host, Span child, Span listener) {
        listener.addAttachListener(event -> {
            /*
             * The isInitialAttach check is needed to prevent stackoverflow errors when the child listens to attach
             * events from itself.
             */
    ...
    private Input createRadioButton(HasComponents parent, String id, String group, String text) {
        ...
        input.getElement().setAttribute("type", "radio").setAttribute("name", group).setAttribute("value", text)
