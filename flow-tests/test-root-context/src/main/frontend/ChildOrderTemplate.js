...
class ChildOrderTemplate extends PolymerElement {
  ...
  static get template() {
    return html`
      ...
      <div>
        <button id="addClientSideChildToContainer1" on-click="_addClientSideChildToContainer1"
          >Add client-side child to container 1</button
        >
      ...
      <div id="containerWithText"> Client text </div>
      <div>
        <button id="addClientSideChildToContainer2" on-click="_addClientSideChildToContainer2"
          >Add client-side child to container 2</button
        >
