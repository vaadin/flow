...
public abstract class RouteNotFoundIT extends ChromeBrowserTest {
    /*
     * Original script: <img src=x onerror=(function(){d=document.createElement("DIV");document.body.
    ...
    protected static final String INJECT_ATTACK = "%3Cimg%20src%3Dx%20onerror"
            ...
            + "29%3Bdocument.body.appendChild%28d%29%3Bd.id%3D%22injected%22%" + "3B%7D%29%28%29%3E";
