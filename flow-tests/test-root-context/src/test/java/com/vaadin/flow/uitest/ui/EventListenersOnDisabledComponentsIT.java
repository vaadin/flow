...
public class EventListenersOnDisabledComponentsIT extends ChromeBrowserTest {

    @Test
    public void clickOnDisabledButton_eventIsNotFired() {
        open();

        WebElement button = findElement(By.id("button"));
        WebElement message = findElement(By.id("message"));
        Assert.assertFalse("The button should be disabled", button.isEnabled());
