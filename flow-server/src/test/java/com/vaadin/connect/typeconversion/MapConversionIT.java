...
public class MapConversionIT extends BaseTypeConversionIT {
  ...
  public void should_ConvertToMapOfString_When_ReceiveMapOfString()
    ...
    assertEqualExpectedValueWhenCallingMethod("getFooMapStringString", inputValue,
        expectedValue);
  }
  ...
  public void should_ConvertToMapOfInteger_When_ReceiveMapOfInteger()
    ...
    assertEqualExpectedValueWhenCallingMethod("getAddOneMapStringInteger", inputValue,
        expectedValue);
  }
  ...
  public void should_ConvertToMapOfDouble_When_ReceiveMapOfDecimal()
    ...
    assertEqualExpectedValueWhenCallingMethod("getAddOneMapStringDouble", inputValue,
        expectedValue);
  }
  ...
  public void should_FailToConvertToMapOfStringEnum_When_ReceiveMapOfStringEnum()
    ...
    assertEqualExpectedValueWhenCallingMethod("getNextEnumMapStringEnum", inputValue,
        expectedValue);
  }
  ...
  public void should_ConvertToMapOfEnumInteger_When_ReceiveMapOfEnumInteger()
    ...
    assertEqualExpectedValueWhenCallingMethod("getAddOneMapEnumInteger", inputValue,
        expectedValue);
  }
}
