...
public class DateTimeConversionIT extends BaseTypeConversionIT {
  ...
  public void should_ConvertToDate_When_ReceiveATimeStampAsNumber() {
    ...
    assertEqualExpectedValueWhenCallingMethod("addOneDayToDate", timeStamp, expectedValue);
  }
  ...
  public void should_ConvertToDate_When_ReceiveATimeStampAsString() {
    ...
    assertEqualExpectedValueWhenCallingMethod("addOneDayToDate", timeStamp, expected);
  }
  ...
  public void should_ConvertToDate_When_ReceiveADate() {
    ...
    assertEqualExpectedValueWhenCallingMethod("addOneDayToDate", inputDate, expectedTimestamp);
  }

  @Test
  public void should_ConvertToNullForDate_When_ReceiveANull() {
    String timeStamp = "null";
    assertEqualExpectedValueWhenCallingMethod("addOneDayToDate", timeStamp, timeStamp);
  }
  // endregion
  ...
  @Test @Ignore("Failing after moved to flow")
  public void should_ConvertToLocalDate_When_ReceiveALocalDate() {
    ...
    assertEqualExpectedValueWhenCallingMethod("addOneDayLocalDate", inputDate,
        expectedTimestamp);
  }
  ...
  public void should_ConvertToLocalDateTime_When_ReceiveALocalDateTime() {
    ...
    assertEqualExpectedValueWhenCallingMethod("addOneDayOneHourLocalDateTime",
