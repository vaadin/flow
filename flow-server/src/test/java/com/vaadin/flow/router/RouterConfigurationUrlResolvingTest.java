...
public class RouterConfigurationUrlResolvingTest extends RoutingTestBase {
    ...
    public void init() throws NoSuchFieldException, IllegalAccessException {
        ...
        routeConfiguration = RouteConfiguration.forRegistry(router.getRegistry());
    }
    ...
    public void basic_url_resolving() throws InvalidRouteConfigurationException {
        ...
        Assert.assertEquals("", routeConfiguration.getUrl(RootNavigationTarget.class));
        Assert.assertEquals("foo", routeConfiguration.getUrl(FooNavigationTarget.class));
        Assert.assertEquals("foo/bar", routeConfiguration.getUrl(FooBarNavigationTarget.class));
    }
    ...
    public void nested_layouts_url_resolving() throws InvalidRouteConfigurationException {
        ...
        Assert.assertEquals("parent/child", routeConfiguration.getUrl(RouteChild.class));
        Assert.assertEquals("single", routeConfiguration.getUrl(LoneRoute.class));
    }

    @Test
    public void layout_with_url_parameter_url_resolving() throws InvalidRouteConfigurationException {
        setNavigationTargets(GreetingNavigationTarget.class, OtherGreetingNavigationTarget.class);

        Assert.assertEquals("greeting/my_param", routeConfiguration.getUrl(GreetingNavigationTarget.class, "my_param"));
        Assert.assertEquals("greeting/true", routeConfiguration.getUrl(GreetingNavigationTarget.class, "true"));

        Assert.assertEquals("greeting/other", routeConfiguration.getUrl(GreetingNavigationTarget.class, "other"));
    }
    ...
    public void url_resolves_correctly_for_optional_and_wild_parameters()
        ...
        Assert.assertEquals("optional/my_param", routeConfiguration.getUrl(OptionalParameter.class, "my_param"));

        Assert.assertEquals("wild/true", routeConfiguration.getUrl(WildParameter.class, "true"));

        Assert.assertEquals("wild/there/are/many/of/us",
                routeConfiguration.getUrl(WildParameter.class, "there/are/many/of/us"));
    }
    ...
    public void wildcardPathWithEmptyParameter_emptyParameterIsAvailable() {
        ...
        router.navigate(ui, new Location("wild//two/three"), NavigationTrigger.PROGRAMMATIC);

        Assert.assertEquals("/two/three", WildParameter.param);

        router.navigate(ui, new Location("wild////four/five"), NavigationTrigger.PROGRAMMATIC);

        Assert.assertEquals("///four/five", WildParameter.param);

        router.navigate(ui, new Location("wild//two//four"), NavigationTrigger.PROGRAMMATIC);
    ...
    public void root_navigation_target_with_wildcard_parameter() throws InvalidRouteConfigurationException {
        ...
        Assert.assertEquals("Expected event amount was wrong", 1, WildRootParameter.events.size());
        Assert.assertEquals("Parameter should be empty", "", WildRootParameter.param);

        router.navigate(ui, new Location("my/wild"), NavigationTrigger.PROGRAMMATIC);

        Assert.assertEquals("Expected event amount was wrong", 2, WildRootParameter.events.size());
        Assert.assertEquals("Parameter should be empty", "my/wild", WildRootParameter.param);

        Assert.assertEquals("", routeConfiguration.getUrl(WildRootParameter.class));
        Assert.assertEquals("wild", routeConfiguration.getUrl(WildRootParameter.class, "wild"));

        List<String> params = Arrays.asList("", null);
        Assert.assertEquals("", routeConfiguration.getUrl(WildRootParameter.class, params.get(1)));
    }
    ...
    public void root_navigation_target_with_optional_parameter() throws InvalidRouteConfigurationException {
        ...
        Assert.assertEquals("Expected event amount was wrong", 1, OptionalRootParameter.events.size());
        ...
        Assert.assertEquals("Expected event amount was wrong", 2, OptionalRootParameter.events.size());
        Assert.assertEquals("Parameter should be empty", "optional", OptionalRootParameter.param);

        Assert.assertEquals("", routeConfiguration.getUrl(OptionalRootParameter.class));
        Assert.assertEquals("optional", routeConfiguration.getUrl(OptionalRootParameter.class, "optional"));

        List<String> params = Arrays.asList("", null);
        Assert.assertEquals("", routeConfiguration.getUrl(OptionalRootParameter.class, params.get(1)));
    }
    ...
    public void getUrl_for_has_url_with_supported_parameters() throws InvalidRouteConfigurationException {
        ...
        Assert.assertEquals("integer/5", routeConfiguration.getUrl(IntegerParameter.class, 5));

        Assert.assertEquals("long/5", routeConfiguration.getUrl(LongParameter.class, 5l));

        Assert.assertEquals("boolean/false", routeConfiguration.getUrl(BooleanParameter.class, false));
    }
    ...
    public void getUrl_throws_for_required_parameter() {
        ...
        expectedEx.expectMessage(
                String.format("Navigation target '%s' requires a parameter.", RouteWithParameter.class.getName()));
    ...
    public void getUrl_returns_url_if_parameter_is_wildcard_or_optional() throws InvalidRouteConfigurationException {
        ...
        String url = routeConfiguration.getUrl(RouteWithMultipleParameters.class);

        Assert.assertEquals("Returned url didn't match Wildcard parameter",
                RouteWithMultipleParameters.class.getAnnotation(Route.class).value(), url);
    ...
    public void getUrlBase_returns_url_without_parameter_even_for_required_parameters()
            throws InvalidRouteConfigurationException {
        setNavigationTargets(RouteWithParameter.class, RouteWithMultipleParameters.class, OptionalParameter.class,
        ...
        Assert.assertEquals("Required parameter didn't match url base.",
                ...
                routeConfiguration.getUrlBase(RouteWithParameter.class).orElse(null));
        Assert.assertEquals("Wildcard parameter didn't match url base.",
                RouteWithMultipleParameters.class.getAnnotation(Route.class).value(),
                routeConfiguration.getUrlBase(RouteWithMultipleParameters.class).orElse(null));
        Assert.assertEquals("Optional parameter didn't match url base.",
                OptionalParameter.class.getAnnotation(Route.class).value(),
                routeConfiguration.getUrlBase(OptionalParameter.class).orElse(null));
        Assert.assertEquals("Non parameterized url didn't match url base.",
                FooNavigationTarget.class.getAnnotation(Route.class).value(),
                routeConfiguration.getUrlBase(FooNavigationTarget.class).orElse(null));
    }
    ...
    public void getTemplate_returns_url_template() throws InvalidRouteConfigurationException {
        ...
        Assert.assertEquals("Required parameter didn't match route template.",
                ...
                routeConfiguration.getTemplate(RouteWithParameter.class).orElse(null));
        Assert.assertEquals("Wildcard parameter didn't match route template.",
                "param/" + HasUrlParameterFormat.PARAMETER + "*",
                routeConfiguration.getTemplate(RouteWithMultipleParameters.class).orElse(null));
        Assert.assertEquals("Optional parameter didn't match route template.",
                "optional/" + HasUrlParameterFormat.PARAMETER + "?",
                routeConfiguration.getTemplate(OptionalParameter.class).orElse(null));
        Assert.assertEquals("Non parameterized url didn't match route template.", "foo",
                routeConfiguration.getTemplate(FooNavigationTarget.class).orElse(null));
    }
    ...
    public void routerLinkInParent_updatesWhenNavigating() throws InvalidRouteConfigurationException {
        ...
        RouteParent routeParent = (RouteParent) ui.getInternals().getActiveRouterTargetsChain().get(1);
        RouterLink loneLink = routeParent.loneLink;

        Assert.assertTrue("Link should be attached", loneLink.getUI().isPresent());
        Assert.assertTrue("Link should be highlighted when navigated to link target",
                loneLink.getElement().hasAttribute("highlight"));

        ui.navigate(routeConfiguration.getUrl(RouteChild.class));

        Assert.assertTrue("Link should be attached", loneLink.getUI().isPresent());
        Assert.assertFalse("Link should not be highlighted when navigated to other target",
                loneLink.getElement().hasAttribute("highlight"));
    }
    ...
    public void navigation_targets_remove_route_with_same_path() throws InvalidRouteConfigurationException {
        ...
        final List<RouteData> availableRoutes = routeConfiguration.getAvailableRoutes();
        ...
        Assert.assertEquals(MyPageWithParam.class, availableRoutes.get(0).getNavigationTarget());
    }
    ...
    public void navigation_targets_remove_route_with_same_path_and_parameter()
        ...
        routeConfiguration.update(() -> routeConfiguration.removeRoute("my/" + HasUrlParameterFormat.PARAMETER));
    ...
    public void navigation_targets_remove_route_target_with_same_path_and_parameter()
        ...
        routeConfiguration.update(() -> routeConfiguration.removeRoute("my", MyPageWithParam.class));
    ...
    private void assertMyPageAndWithParamAvailable() {
        ...
        Assert.assertEquals(MyPageWithParam.class,
                routeConfiguration.getRoute("my/" + HasUrlParameterFormat.PARAMETER).get());
        Assert.assertEquals(MyPageWithParam.class,
                routeConfiguration.getRoute("my", Arrays.asList(HasUrlParameterFormat.PARAMETER)).get());
    }
    ...
    public void navigation_targets_with_same_route_and_two_with_parameter() throws InvalidRouteConfigurationException {
        setNavigationTargets(MyPage.class, MyPageWithParam.class, MyPageWithWildcardParam.class);

        assertSameRouteWithParams();

        Assert.assertEquals("my/:" + HasUrlParameterFormat.PARAMETER_NAME + "*",
                routeConfiguration.getTemplate(MyPageWithWildcardParam.class).get());

        Assert.assertEquals("my/wild/value", routeConfiguration.getUrl(MyPageWithWildcardParam.class, "wild/value"));
        Assert.assertEquals("my/wild/value", routeConfiguration.getUrl(MyPageWithWildcardParam.class,
                new RouteParameters(HasUrlParameterFormat.PARAMETER_NAME, "wild/value")));

        Assert.assertEquals(MyPageWithWildcardParam.class, routeConfiguration.getRoute("my/wild/param").get());
    }

    private void assertSameRouteWithParams() {
        Assert.assertEquals("my", routeConfiguration.getTemplate(MyPage.class).get());
        Assert.assertEquals("my/:" + HasUrlParameterFormat.PARAMETER_NAME,
                routeConfiguration.getTemplate(MyPageWithParam.class).get());

        Assert.assertEquals("my", routeConfiguration.getUrl(MyPage.class));
        Assert.assertEquals("my/value", routeConfiguration.getUrl(MyPageWithParam.class, "value"));
        Assert.assertEquals("my/value", routeConfiguration.getUrl(MyPageWithParam.class,
                new RouteParameters(HasUrlParameterFormat.PARAMETER_NAME, "value")));

        Assert.assertEquals(MyPage.class, routeConfiguration.getRoute("my").get());
        Assert.assertEquals(MyPageWithParam.class, routeConfiguration.getRoute("my/param").get());
    }
    ...
    @Route("my")
    @Tag(Tag.DIV)
    public class MyPageWithParam extends Component implements HasUrlParameter<String> {
    ...
    @Route("my")
    @Tag(Tag.DIV)
    public class MyPageWithWildcardParam extends Component implements HasUrlParameter<String> {

        @Override
        public void setParameter(BeforeEvent event, @com.vaadin.flow.router.WildcardParameter String parameter) {
        }
    }
