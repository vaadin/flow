...
public class QueryParametersTest {
    ...
    private String simpleInputQueryString = "one=1&two=2&three=3&four&five=4%2f5%266";

    private String complexInputQueryString = "one=1&one=11&two=2&two=22&three=3&four&five=4%2f5%266";
    ...
    public void simpleParametersFromQueryString() {
        ...
        expectedFullParams.put("five", Collections.singletonList("4/5&6"));
        assertEquals(expectedFullParams, simpleParams.getParameters());
    }
