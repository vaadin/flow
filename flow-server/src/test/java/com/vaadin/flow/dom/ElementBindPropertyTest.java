...
public class ElementBindPropertyTest {
    ...
    public void bindProperty_nullProperty_throwException() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> element.bindProperty(null, signal, signal::get));
    }
    ...
    public void bindProperty_illegalProperty_throwException() {
        Element element = new Element("foo");
        ValueSignal<String> signal = new ValueSignal<>("bar");
        assertThrows(IllegalArgumentException.class, () -> element
                .bindProperty("textContent", signal, signal::get));
        assertThrows(IllegalArgumentException.class,
                () -> element.bindProperty("classList", signal, signal::get));
        assertThrows(IllegalArgumentException.class,
                () -> element.bindProperty("className", signal, signal::get));
        assertThrows(IllegalArgumentException.class,
                () -> element.bindProperty("outerHTML", signal, signal::get));
    }
    ...
    public void bindProperty_notComponent_doNotThrowException() {
        ...
        element.bindProperty("foobar", signal, signal::get);
    ...
    public void bindProperty_setPropertyWhileBindingIsActive_throwException() {
        ...
        component.getElement().bindProperty("foo", signal, signal::get);
    ...
    public void bindDoubleProperty_componentNotAttached_bindingIgnored() {
        ...
        component.getElement().bindProperty("foo", signal, signal::value);
    ...
    public void bindProperty_writeCallbackThrows() {
        ...
        component.getElement().addPropertyChangeListener("prop", "change",
                event -> {
                    Assert.fail(
                            "Property change listener should not be triggered when write callback throws");
                });
    ...
    public void bindProperty_normalCallback_valueChangeEventTriggered() {
        ...
        UI.getCurrent().add(component);
        ValueSignal<String> signal = new ValueSignal<>("foo");
        component.getElement().bindProperty("prop", signal, signal::value);
    ...
    public void bindProperty_noOpCallback_valueChangeEventNotTriggered() {
        ...
        component.getElement().addPropertyChangeListener("prop", "change",
                event -> {
                    Assert.fail(
                            "Property change listener should not be triggered with a no-op callback");
                });
