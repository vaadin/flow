...
public class PendingJavaScriptInvocationTest {
    private static final JsonNode fooJsonString = JacksonUtils.getMapper()
            .valueToTree("foo");
    ...
    public void blockFromSessionThreadAfterFailing_doesNotThrow()
        ...
        session.runWithLock(() -> {
            ...
            invocation.completeExceptionally((JsonNode) JacksonUtils.getMapper()
                    .valueToTree(errorMessage));
