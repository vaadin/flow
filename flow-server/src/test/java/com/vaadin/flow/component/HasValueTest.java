...
public class HasValueTest {
    ...
    private class HasValueImp extends RouterLink implements HasValue<RouterLink, String> {
        ...
        public String getValue() {
            return getElement().getProperty(getClientValuePropertyName(), getEmptyValue());
        }
    }
    ...
    public void testValueChangeListener_valueChangedFromServer_triggersEvent() {
        ...
        Assert.assertNotNull("event should have been triggered", reference.get());
        ...
        Assert.assertEquals("invalid previous value","foobar", event.getOldValue());
