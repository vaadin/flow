...
public class HistoryTest {
    ...
    private static final String PUSH_STATE_REACT = "window.history.pushState($0, '', $1);";
    private static final String REPLACE_STATE_REACT = "window.history.replaceState($0, '', $1);";
