...
public class SvgTest {
    ...
    public void simpleSvg() {
        ...
        Assert.assertEquals(TRIVIAL_SVG, html.getElement().getProperty("innerHTML"));
    }
    
    @Test
    public void withDocType() {
        Svg html = new Svg(SVG_WITH_DOCTYPE_ET_AL);
        Assert.assertTrue(html.getElement().getProperty("innerHTML").startsWith("<svg"));
    }
    ...
    public void setHtmlContent() {
        ...
        Assert.assertEquals(TRIVIAL_SVG2, html.getElement().getProperty("innerHTML"));
    }
    
    @Test
    public void fromStream() {
        Svg svg = new Svg(new ByteArrayInputStream(
                TRIVIAL_SVG.getBytes()));
        Assert.assertEquals(TRIVIAL_SVG, svg.getElement().getProperty("innerHTML"));
    }
