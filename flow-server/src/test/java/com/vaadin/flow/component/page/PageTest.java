                ...
                return new PendingJavaScriptResult() {
                    ...
                    public void then(
                        ...
                        invocations.add(() -> resultHandler.accept(
                                JacksonUtils.createObject(params, JacksonUtils
                                        .getMapper()::valueToTree)));
                    }
                };
            }
        };
                ...
                return new PendingJavaScriptResult() {
                    ...
                    public void then(
                        ...
                        resultHandler.accept(JacksonUtils.createObject(params,
                                JacksonUtils.getMapper()::valueToTree));
                    }
                };
            }
        };
            ...
            public PendingJavaScriptResult executeJs(String expression,
                ...
                return new PendingJavaScriptResult() {
                    ...
                    public void then(
                            SerializableConsumer<JsonNode> resultHandler,
                            SerializableConsumer<String> errorHandler) {
                        resultHandler.accept(JacksonUtils.getMapper()
                                .valueToTree("http://localhost:8080/home"));
                    }
                };
            }
        };
