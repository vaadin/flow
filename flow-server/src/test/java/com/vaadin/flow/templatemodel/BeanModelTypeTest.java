...
public class BeanModelTypeTest {
    ...
    public void clientUpdateModes() {
        ...
        Assert.assertEquals(ClientUpdateMode.ALLOW,
                bean1Type.getClientUpdateMode("string").get());
        Assert.assertEquals(ClientUpdateMode.DENY,
                bean1Type.getClientUpdateMode("booleanValue").get());
        Assert.assertEquals(ClientUpdateMode.ALLOW,
                bean1Type.getClientUpdateMode("booleanObject").get());
        Assert.assertFalse(
                bean1Type.getClientUpdateMode("intValue").isPresent());

        Assert.assertEquals(ClientUpdateMode.ALLOW,
                bean2Type.getClientUpdateMode("string").get());
        Assert.assertEquals(ClientUpdateMode.DENY,
                bean2Type.getClientUpdateMode("booleanValue").get());
        Assert.assertFalse(
                bean2Type.getClientUpdateMode("booleanObject").isPresent());
        Assert.assertEquals(ClientUpdateMode.ALLOW,
                bean2Type.getClientUpdateMode("intValue").get());
    }
