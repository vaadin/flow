...
public class StringUtilTest {
    ...
    public void commentRemoval_handlesCommentsCorrectly() {
        String singleLineBlock = StringUtil.removeComments("return html'/* single line block comment*/';");
    ...
    public void removeJsComments_handlesApostropheAsInString() {
        ...
        String singleLineBlock = StringUtil.removeComments("return html`/* single line block comment*/`;", true);
        ...
        String noComments = "<vaadin-text-field label=\"Nats Url(s)\" placeholder=\"nats://server:port\" id=\"natsUrlTxt\" style=\"width:100%\"></vaadin-text-field>`";
        Assert.assertEquals(noComments, StringUtil.removeComments(noComments, true));
    ...
    public void stripSuffix() {
        ...
        Assert.assertEquals("foobar", StringUtil.stripSuffix("foobarbar", "bar"));
