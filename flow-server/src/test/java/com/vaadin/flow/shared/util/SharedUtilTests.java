...
public class SharedUtilTests {
    ...
    public void upperCamelCaseToDashSeparatedLowerCase() {
        Assert.assertEquals(null, SharedUtil.upperCamelCaseToDashSeparatedLowerCase(null));
        Assert.assertEquals("", SharedUtil.upperCamelCaseToDashSeparatedLowerCase(""));
        Assert.assertEquals("foo", SharedUtil.upperCamelCaseToDashSeparatedLowerCase("foo"));
        Assert.assertEquals("foo-bar", SharedUtil.upperCamelCaseToDashSeparatedLowerCase("fooBar"));
        Assert.assertEquals("foo--bar", SharedUtil.upperCamelCaseToDashSeparatedLowerCase("foo--bar"));
        Assert.assertEquals("foo-bar-baz", SharedUtil.upperCamelCaseToDashSeparatedLowerCase("fooBarBaz"));
        Assert.assertEquals("my-bean-container", SharedUtil.upperCamelCaseToDashSeparatedLowerCase("MyBeanContainer"));
        Assert.assertEquals("awesome-url-factory",
                SharedUtil.upperCamelCaseToDashSeparatedLowerCase("AwesomeURLFactory"));
        Assert.assertEquals("some-uri-action", SharedUtil.upperCamelCaseToDashSeparatedLowerCase("someUriAction"));
    }
    ...
    private static final String[] URIS = new String[] { "http://demo.vaadin.com/", //
            "https://demo.vaadin.com/", "http://demo.vaadin.com/foo", "http://demo.vaadin.com/foo?f",
            "http://demo.vaadin.com/foo?f=1", "http://demo.vaadin.com:1234/foo?a",
    ...
    public void testParameterAdding() {
        String[] urisWithAbcdParam = new String[] { "http://demo.vaadin.com/?a=b&c=d",
                "https://demo.vaadin.com/?a=b&c=d", "http://demo.vaadin.com/foo?a=b&c=d",
                "http://demo.vaadin.com/foo?f&a=b&c=d", "http://demo.vaadin.com/foo?f=1&a=b&c=d",
                "http://demo.vaadin.com:1234/foo?a&a=b&c=d", "http://demo.vaadin.com:1234/foo?a=b&c=d#frag?fakeparam",
        ...
        String[] urisWithAbcdParamAndFragment = new String[] { "http://demo.vaadin.com/?a=b&c=d#fragment",
                "https://demo.vaadin.com/?a=b&c=d#fragment", "http://demo.vaadin.com/foo?a=b&c=d#fragment",
                "http://demo.vaadin.com/foo?f&a=b&c=d#fragment", "http://demo.vaadin.com/foo?f=1&a=b&c=d#fragment",
        ...
        for (int i = 0; i < URIS.length; i++) {
            ...
            // Adding a=b&c=d
            assertEquals(urisWithAbcdParam[i], SharedUtil.addGetParameters(URIS[i], "a=b&c=d"));

            // Fragments
            if (urisWithAbcdParamAndFragment[i].length() > 0) {
                assertEquals(urisWithAbcdParamAndFragment[i],
                        SharedUtil.addGetParameters(URIS[i] + "#fragment", "a=b&c=d"));

                // Empty fragment
                assertEquals(urisWithAbcdParamAndFragment[i].replace("#fragment", "#"),
