...
public class DependencyTest {
    ...
    public void dynamicDependency_hasLazyMode() {
        ...
        assertThat(dependency.getLoadMode(), CoreMatchers.equalTo(LoadMode.LAZY));
    }
    ...
    private void assertDependency(Dependency dependency) {
        ...
        assertThat("No contents should be present in json now", dependencyJson.hasKey(Dependency.KEY_CONTENTS),
                is(false));
