...
public class EnumDecoderJacksonTest {
    ...
    public void isApplicable_applicableToStringAndEnum() {
        Assert.assertTrue(
                decoder.isApplicable(JacksonUtils.createNode("foo"), Title.class));
    }

    @Test
    public void isApplicable_notApplicableToBooleanAndEnum() {
        Assert.assertFalse(decoder.isApplicable(JacksonUtils.createNode(true), Enum.class));
    }
    ...
    public void isApplicable_notApplicableToStringAndAbstractEnum() {
        Assert.assertFalse(
                decoder.isApplicable(JacksonUtils.createNode("foo"), Enum.class));
    }
    ...
    public void stringToEnum_convertableString_valueIsConverted()
        ...
        Title decoded = decoder.decode(JacksonUtils.createNode(title.name()), Title.class);
