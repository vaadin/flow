...
package com.vaadin.flow.server.connect.generator.exports.json;
...
public class JsonTestExportGeneratedTest
    extends AbstractExportGenerationTest {

  public JsonTestExportGeneratedTest() {
    super(Arrays.asList(JsonTestExport.class, Version.class));
  }
  ...
  public void should_GenerateOpenApiWithCustomApplicationProperties_When_InputApplicationPropertiesGiven() {
    verifyGenerationFully(
        AbstractExportGenerationTest.class
