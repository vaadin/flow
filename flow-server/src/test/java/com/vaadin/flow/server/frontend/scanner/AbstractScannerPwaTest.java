...
public abstract class AbstractScannerPwaTest {
    abstract protected PwaConfiguration getPwaConfiguration(Class<?>... classes) throws Exception;
    ...
    public void should_throw_When_MultipleAppShellPwa() throws Exception {
        getPwaConfiguration(AppShellWithPwa.class, AnotherAppShellWithPwa.class);
    }
}
