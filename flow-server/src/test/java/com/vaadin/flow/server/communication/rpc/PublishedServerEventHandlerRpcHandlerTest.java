...
public class PublishedServerEventHandlerRpcHandlerTest {
    ...
    public static class ComponentWithNoClientCallableMethod extends ComponentWithCompute {
    ...
    public static class CompositeOfComponentWithCompute extends Composite<ComponentWithCompute> {
    }

    public static class CompositeOfComposite extends Composite<CompositeOfComponentWithCompute> {
    }
    ...
    public void methodIsInvokedWhenInertAndInertAllowed() {
        ComponentWithCompute component = new ComponentWithCompute();
        PublishedServerEventHandlerRpcHandler.invokeMethod(component, component.getClass(),
                "methodThatCanBeCalledWhenInert", Json.createArray(), -1, true);
    ...
    public void methodWithDecoderParameters_convertableValues_methodIsInvoked() {
        ...
        ui.add(component);
        PublishedServerEventHandlerRpcHandler.invokeMethod(component, component.getClass(), "method", params, -1);
    ...
    public void promiseSuccess() {
        ...
        ui.getInternals().getStateTree().runExecutionsBeforeClientResponse();
        List<PendingJavaScriptInvocation> pendingJavaScriptInvocations = ui.getInternals()
        ...
        Assert.assertTrue("Invocation does not look like a promise callback",
                invocation.getExpression().contains(JsonConstants.RPC_PROMISE_CALLBACK_NAME));
        ...
        Assert.assertEquals("Promise id should match the value passed to invokeMethod", Integer.valueOf(promiseId),
                parameters.get(0));
    ...
    public void promiseFailure() {
        ...
        try {
            PublishedServerEventHandlerRpcHandler.invokeMethod(component, component.getClass(), "compute", args,
                    promiseId);
