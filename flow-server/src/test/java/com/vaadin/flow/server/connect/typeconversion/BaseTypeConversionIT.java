...
@WebMvcTest
@Import(VaadinConnectTypeConversionExports.class)
public abstract class BaseTypeConversionIT {
    ...
    protected MockHttpServletResponse callMethod(String methodName,
        ...
        String exportName = VaadinConnectTypeConversionExports.class
                .getSimpleName();
        String requestUrl = String.format("/%s/%s", exportName, methodName);
