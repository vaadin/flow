...
public class BundleFilterInitializerTest {
    ...
    private void serviceInit(String bundleName) {
        ...
        // First filter in list is ES6, it should filter dependencies when browser is ES6
        ...
        // Second filter in list is ES5, it should filter dependencies when browser is ES6
