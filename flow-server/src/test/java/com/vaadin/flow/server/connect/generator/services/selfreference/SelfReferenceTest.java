 ...
 * the License.
 */
package com.vaadin.flow.server.connect.generator.services.selfreference;

import com.vaadin.flow.server.connect.generator.services.AbstractServiceGenerationTest;
import java.util.Arrays;
import org.junit.Test;

public class SelfReferenceTest extends AbstractServiceGenerationTest {

  public SelfReferenceTest() {
    super(Arrays.asList(SelfReferenceService.class, SelfReference.class));
  }
