 ...
 * the License.
 */
package com.vaadin.flow.server.connect.generator.modelpackage;

import java.util.Arrays;

import org.junit.Test;

import com.vaadin.flow.server.connect.generator.modelpackage.subpackage.Account;
...
public class ModelPackageTest extends AbstractServiceGenerationTest {
    ...
    public ModelPackageTest() {
        super(Arrays.asList(ModelPackageService.class,
                SubModelPackageService.class, Account.class));
    }
