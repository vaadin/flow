...
public class SerializationIT extends BaseTypeConversionIT {

    @Test
    //https://github.com/vaadin/flow/issues/8034
    public void should_BeAbleToSerialzeABeanWithZonedDateTimeField() {
        try {
            String result = callMethod("getBeanWithZonedDateTimeField").getContentAsString();
