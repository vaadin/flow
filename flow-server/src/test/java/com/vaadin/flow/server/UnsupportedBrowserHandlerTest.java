...
public class UnsupportedBrowserHandlerTest {
    ...
    private void initMocks(boolean forceReloadCookie,
            boolean isTooOldToFunctionProperly, boolean isIE,
            boolean isEs6Supported) throws IOException {
        ...
        Mockito.when(webBrowser.isEs6Supported()).thenReturn(isEs6Supported);
    ...
    @Test
    public void testUnsupportedBrowserHandler_validBrowserInProductionMode_doesntHandleRequest()
            throws IOException {
    ...
    @Test
    public void testUnsupportedBrowserHandler_validBrowserInDevelopmentMode_doesntHandleRequest()
            throws IOException {
        initMocks(false, false, false, true);
    ...
    public void testUnsupportedBrowserHandler_tooOldBrowserWithForceReloadCookie_doesntHandleRequest()
            throws IOException {
        initMocks(true, true, false, true);
    ...
    @Test
    public void testUnsupportedBrowserHandler_IE11WithProductionMode_doesntHandleRequest()
            throws IOException {
    ...
    @Test
    public void testUnsupportedBrowserHandler_IE11WithDevelopmentModeAndForceReload_doesntHandleRequest()
            throws IOException {
    ...
    public void testUnsupportedBrowserHandler_IE11WithDevelopmentMode_returnsTranspilationRequiredPage()
        ...
        Assert.assertTrue("Unsupported browser page not used", pageCapture
                .getValue().contains("This browser requires transpilation"));
    }

    @Test
    public void testUnsupportedBrowserHandler_IE11WithDevelopmentModeAndDevmodeTranspilation_doesntHandleRequest()
            throws IOException {
        initMocks(false, false, true, false);

        configuration.setApplicationOrSystemProperty(
                SERVLET_PARAMETER_DEVMODE_TRANSPILE, "true");
