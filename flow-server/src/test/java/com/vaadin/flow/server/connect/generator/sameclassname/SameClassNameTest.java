...
import com.vaadin.flow.server.connect.generator.sameclassname.subpackage.SameClassNameModel;
import com.vaadin.flow.server.connect.generator.sameclassname.subpackage.SubProperty;

public class SameClassNameTest extends AbstractServiceGenerationTest {

    public SameClassNameTest() {
        super(Arrays.asList(SameClassNameService.class,
