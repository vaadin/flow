...
public class StringToNumberDecoderJacksonTest {
    ...
    public void isApplicable_applicableToStringAndNumber() {
        Assert.assertTrue(
                decoder.isApplicable(JacksonUtils.createNode("foo"), Number.class));
    }

    @Test
    public void isApplicable_notApplicableToBooleanAndNumber() {
        Assert.assertFalse(
                decoder.isApplicable(JacksonUtils.createNode(true), Number.class));
    }

    @Test
    public void isApplicable_notApplicableToStringAndString() {
        Assert.assertFalse(
                decoder.isApplicable(JacksonUtils.createNode("foo"), String.class));
    }

    @Test
    public void isApplicable_notApplicableToStringAndAtomicInteger() {
        Assert.assertFalse(
                decoder.isApplicable(JacksonUtils.createNode("foo"), AtomicInteger.class));
    }

    @Test
    public void isApplicable_applicableToStringAndLong() {
        Assert.assertTrue(decoder.isApplicable(JacksonUtils.createNode("foo"), Long.class));
    }
    ...
    public void stringToInteger_convertableString_valueIsConverted()
        ...
        Integer expected = 37;
        Integer value = decoder.decode(JacksonUtils.createNode(String.valueOf(expected)),
                Integer.class);
    ...
    public void stringToLong_convertableString_valueIsConverted()
            throws RpcDecodeException {
        Long expected = 37l;
        Long value = decoder.decode(JacksonUtils.createNode(String.valueOf(expected)),
                Long.class);
        Assert.assertEquals(expected, value);
    }
    ...
    public void stringToShort_convertableString_valueIsConverted()
            throws RpcDecodeException {
        Short expected = 37;
        Short value = decoder.decode(JacksonUtils.createNode(String.valueOf(expected)),
                Short.class);
        Assert.assertEquals(expected, value);
    }
    ...
    public void stringToByte_convertableString_valueIsConverted()
            throws RpcDecodeException {
        Byte expected = 37;
        Byte value = decoder.decode(JacksonUtils.createNode(String.valueOf(expected)),
                Byte.class);
        Assert.assertEquals(expected, value);
    }
    ...
    public void stringToFloat_convertableString_valueIsConverted()
        ...
        Float value = decoder.decode(JacksonUtils.createNode(String.valueOf(expected)),
                Float.class);
        Assert.assertEquals(expected, value);
    }
    ...
    public void stringToFloat_doubleString_exceptionIsThrown()
            throws RpcDecodeException {
        decoder.decode(JacksonUtils.createNode(String.valueOf(Double.MIN_NORMAL)),
                Float.class);
    }
    ...
    public void stringToDouble_convertableString_valueIsConverted()
        ...
        Double value = decoder.decode(JacksonUtils.createNode(String.valueOf(expected)),
                Double.class);
        Assert.assertEquals(expected, value);
    }
    ...
    public void stringToNumber_convertableString_valueIsConverted()
            throws RpcDecodeException {
        Double expected = 823.6349d;
        Number value = decoder.decode(JacksonUtils.createNode(String.valueOf(expected)),
                Number.class);
        Assert.assertEquals(expected, value);
    }
}
