...
public class BundleValidationTest {
    ...
    public void init() {
        ...
        options.withProductionMode(prodMode);
    ...
    public void noDevBundle_bundleCompilationRequires() throws IOException {
        final boolean needsBuild = BundleValidationUtil.needsBuildInternal(
    ...
    public void hashesMatch_noNpmPackages_noCompilationRequired()
        ...
        final boolean needsBuild = BundleValidationUtil
    ...
    public void hashesMatch_packageJsonHasTildeRange_statsHasNewerFixed_noCompilationRequired()
        ...
        boolean needsBuild = BundleValidationUtil.needsBuildInternal(options,
                depScanner, finder);
        ...
        needsBuild = BundleValidationUtil.needsBuildInternal(options, depScanner,
                finder);
        Assert.assertTrue(
