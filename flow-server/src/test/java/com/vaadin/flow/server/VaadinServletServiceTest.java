...
public class VaadinServletServiceTest {
    ...
    public void getResourceTheme() throws IOException {
        ...
        testGetResourceAndGetResourceAsStream(
                ...
                "frontend://vaadin-button/raw/raw-only.txt", browser, theme);
        // Only themed version
        ...
        testGetResourceAndGetResourceAsStream(
                ...
                "frontend://vaadin-button/raw/theme-only.txt", browser, theme);
        ...
        testGetResourceAndGetResourceAsStream(
                ...
                "frontend://vaadin-button/raw/has-theme-variant.txt", browser,
                theme);
        testGetResourceAndGetResourceAsStream(
                "/frontend/theme/has-theme-variant.txt",
        ...
        testGetResourceAndGetResourceAsStream(
                "/webjars/vaadin-button/theme/has-theme-variant.txt",
                "frontend://vaadin-button/theme/has-theme-variant.txt", browser,
                theme);
    }
