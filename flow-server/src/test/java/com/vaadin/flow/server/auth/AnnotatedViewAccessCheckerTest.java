...
public class AnnotatedViewAccessCheckerTest {
    ...
    public void anonymousAccessToAnonymousViewAllowed() {
        AccessCheckResult result = checkAccess(AnonymousAllowedView.class, null);
    ...
    public void anonymousAccessToRolesAllowedUserViewDenied() {
        AccessCheckResult result = checkAccess(RolesAllowedUserView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void anonymousAccessToRolesAllowedAdminViewDenied() {
        AccessCheckResult result = checkAccess(RolesAllowedAdminView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccessToAnonymousViewAllowed() {
        AccessCheckResult result = checkAccess(AnonymousAllowedView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInNoRolesAccessToNoAnnotationViewDenied() {
        AccessCheckResult result = checkAccess(NoAnnotationView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccessToPermitAllViewAllowed() {
        AccessCheckResult result = checkAccess(PermitAllView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInNoRolesAccessToDenyAllViewDenied() {
        AccessCheckResult result = checkAccess(DenyAllView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccessToRolesAllowedUserViewDenied() {
        AccessCheckResult result = checkAccess(RolesAllowedUserView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccessToRolesAllowedAdminViewDenied() {
        AccessCheckResult result = checkAccess(RolesAllowedAdminView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInUserRoleAccessToAnonymousViewAllowed() {
        AccessCheckResult result = checkAccess(AnonymousAllowedView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInUserRoleAccessToNoAnnotationViewDenied() {
        AccessCheckResult result = checkAccess(NoAnnotationView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInUserRoleAccessToPermitAllViewAllowed() {
        AccessCheckResult result = checkAccess(PermitAllView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInUserRoleAccessToDenyAllViewDenied() {
        AccessCheckResult result = checkAccess(DenyAllView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInUserRoleAccessToRolesAllowedUserViewAllowed() {
        AccessCheckResult result = checkAccess(RolesAllowedUserView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInUserRoleAccessToRolesAllowedAdminViewDenied() {
        AccessCheckResult result = checkAccess(RolesAllowedAdminView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInAdminRoleAccessToAnonymousViewAllowed() {
        AccessCheckResult result = checkAccess(AnonymousAllowedView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInAdminRoleAccessToNoAnnotationViewDenied() {
        AccessCheckResult result = checkAccess(NoAnnotationView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }
    ...
    public void loggedInAdminRoleAccessToRolesAllowedUserViewDenied() {
        AccessCheckResult result = checkAccess(RolesAllowedUserView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInAdminRoleAccessToRolesAllowedAdminViewAllowed() {
        AccessCheckResult result = checkAccess(RolesAllowedAdminView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }
    ...
    public void openingNoAnnotationViewShowsReasonAndHint() {
        AccessCheckResult result = checkAccess(NoAnnotationView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckResult.deny("Consider adding one of the following annotations "
                + "to make the view accessible: @AnonymousAllowed, " + "@PermitAll, @RolesAllowed."), result);
    }

    @Test
    public void anonymousAccess_to_noAnnotationAnonymousAllowedByParent_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationAnonymousAllowedByParentView.class, null);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void anonymousAccess_to_noAnnotationAnonymousAllowedByGrandParent_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationAnonymousAllowedByGrandParentView.class, null);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void anonymousAccess_to_noAnnotationPermitAllByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationPermitAllByGrandParentView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void anonymousAccess_to_noAnnotationDenyAllByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationDenyAllByGrandParentView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void anonymousAccess_to_noAnnotationRolesAllowedUserByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedUserByGrandParentView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void anonymousAccess_to_noAnnotationRolesAllowedAdminByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedAdminByGrandParentView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccess_to_noAnnotationAnonymousAllowedByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationAnonymousAllowedByGrandParentView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInNoRolesAccess_to_noAnnotationPermitAllByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationPermitAllByGrandParentView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInNoRolesAccess_to_noAnnotationDenyAllByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationDenyAllByGrandParentView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccess_to_noAnnotationRolesAllowedUserByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedUserByGrandParentView.class, User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccess_to_noAnnotationRolesAllowedAdminByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedAdminByGrandParentView.class,
                User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }
    ...
    public void loggedInUserRoleAccess_to_noAnnotationAnonymousAllowedByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationAnonymousAllowedByGrandParentView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInUserRoleAccess_to_noAnnotationPermitAllByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationPermitAllByGrandParentView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInUserRoleAccess_to_noAnnotationDenyAllByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationDenyAllByGrandParentView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInUserRoleAccess_to_noAnnotationRolesAllowedUserByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedUserByGrandParentView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInUserRoleAccess_to_noAnnotationRolesAllowedAdminByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedAdminByGrandParentView.class, User.NORMAL_USER);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInAdminRoleAccess_to_noAnnotationAnonymousAllowedByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationAnonymousAllowedByGrandParentView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInAdminRoleAccess_to_noAnnotationPermitAllByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationPermitAllByGrandParentView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void loggedInAdminRoleAccess_to_noAnnotationDenyAllByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationDenyAllByGrandParentView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInAdminRoleAccess_to_noAnnotationRolesAllowedUserByGrandParentView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedUserByGrandParentView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInAdminRoleAccess_To_noAnnotationRolesAllowedAdminByGrandParentView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationRolesAllowedAdminByGrandParentView.class, User.ADMIN);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }
    ...
    public void anyAccess_to_noAnnotationDenyAllAsInterfacesIgnoredView_denied() {
        Assert.assertEquals(AccessCheckDecision.DENY,
                checkAccess(NoAnnotationDenyAllAsInterfacesIgnoredView.class, null).decision());

        Assert.assertEquals(AccessCheckDecision.DENY,
                checkAccess(NoAnnotationDenyAllAsInterfacesIgnoredView.class, User.USER_NO_ROLES).decision());

        Assert.assertEquals(AccessCheckDecision.DENY,
                checkAccess(NoAnnotationDenyAllAsInterfacesIgnoredView.class, User.NORMAL_USER).decision());

        Assert.assertEquals(AccessCheckDecision.DENY,
                checkAccess(NoAnnotationDenyAllAsInterfacesIgnoredView.class, User.ADMIN).decision());
    }

    @Test
    public void anonymousAccess_to_noAnnotationPermitAllByGrandParentAsInterfacesIgnoredView_denied() {
        AccessCheckResult result = checkAccess(NoAnnotationPermitAllByGrandParentAsInterfacesIgnoredView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void loggedInNoRolesAccess_to_noAnnotationPermitAllByGrandParentAsInterfacesIgnoredView_allowed() {
        AccessCheckResult result = checkAccess(NoAnnotationPermitAllByGrandParentAsInterfacesIgnoredView.class,
                User.USER_NO_ROLES);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }
    ...
    public void rerouteToError_customAnonymousErrorHandler_allowed() {
        AccessCheckResult result = checkAccess(AccessControlTestClasses.CustomErrorView.class, null);
        Assert.assertEquals(AccessCheckResult.allow(), result);
    }

    @Test
    public void rerouteToError_customNotAnnotatedErrorHandler_deny() {
        AccessCheckResult result = checkAccess(AccessControlTestClasses.NotAnnotatedCustomErrorView.class, null);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }

    @Test
    public void routeWithNoAnnotationLayout_deny() {
        NavigationContext context = setupNavigationContext(AccessControlTestClasses.AnonymousAllowedView.class, null);
        RouteRegistry registry = context.getRouter().getRegistry();
        Mockito.when(registry.hasLayout("anon")).thenReturn(true);
        Mockito.when(registry.getLayout("anon")).thenAnswer(invocation -> AccessControlTestClasses.NoAuthLayout.class);
    ...
    public void routeWithNoAnnotationsAllowedLayout_allowed() {
        ...
        RouteRegistry registry = context.getRouter().getRegistry();
        Mockito.when(registry.hasLayout("anon")).thenReturn(true);
        Mockito.when(registry.getLayout("anon"))
                .thenAnswer(invocation -> AccessControlTestClasses.AnonymousAllowedLayout.class);
        AccessCheckResult result = this.viewAccessChecker.check(context);
    ...
    public void routeWithNoAnnotationsAllowed_LayoutWithAllowed_denied() {
        NavigationContext context = setupNavigationContext(AccessControlTestClasses.NoAnnotationView.class, null);
        RouteRegistry registry = context.getRouter().getRegistry();
        Mockito.when(registry.hasLayout("noannotation")).thenReturn(true);
        Mockito.when(registry.getLayout("noannotation"))
                .thenAnswer(invocation -> AccessControlTestClasses.AnonymousAllowedLayout.class);
        AccessCheckResult result = this.viewAccessChecker.check(context);
        Assert.assertEquals(AccessCheckDecision.DENY, result.decision());
    }
