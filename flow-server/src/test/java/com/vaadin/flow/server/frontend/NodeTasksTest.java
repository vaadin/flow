...
public class NodeTasksTest {
    ...
    @Test
    public void should_UseDefaultFolders() {
        ...
        Assert.assertEquals(new File(userDir, DEFAULT_FRONTEND_DIR).getAbsolutePath(), builder.frontendDirectory.getAbsolutePath());
        Assert.assertEquals(new File(userDir, DEFAULT_GENERATED_DIR).getAbsolutePath(), builder.generatedPath.getAbsolutePath());
    ...
    @Test
    public void should_BeAbleToCustomizeFolders() {
        ...
        Assert.assertEquals(new File(userDir, "my_custom_sources_folder").getAbsolutePath(), builder.frontendDirectory.getAbsolutePath());
        Assert.assertEquals(new File(userDir, "my/custom/generated/folder").getAbsolutePath(), builder.generatedPath.getAbsolutePath());
