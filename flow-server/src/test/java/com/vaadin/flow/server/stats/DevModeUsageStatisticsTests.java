...
public class DevModeUsageStatisticsTests extends TestCase {
    ...
    public void testClientData() throws Exception {
        ...
        DeploymentConfiguration configuration = mockAppConfig(true);
  ...
  // @Test FIXME does not apply for flow-server module ?
  ...
  //}
    ...
    private DeploymentConfiguration mockAppConfig(boolean enabled) {
            DeploymentConfiguration appConfig = Mockito
