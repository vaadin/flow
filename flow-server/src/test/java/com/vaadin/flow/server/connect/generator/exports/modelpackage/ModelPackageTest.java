...
public class ModelPackageTest extends AbstractExportGenerationTest {

    public ModelPackageTest() {
        super(Arrays.asList(ModelPackageExport.class,
                SubModelPackageExport.class, Account.class));
    }
