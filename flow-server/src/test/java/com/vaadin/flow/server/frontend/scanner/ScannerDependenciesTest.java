...
public class ScannerDependenciesTest {
    ...
    public void should_extractClassesFromSignatures() {
        ...
        assertArrayEquals(new String[] { "java.lang.Float", "com.vaadin.flow.component.button.Button",
                "java.lang.Character", "java.lang.Long", "java.lang.Double", "java.lang.Boolean",
                "com.vaadin.flow.component.tabs.Tabs", "java.lang.String", "java.lang.Byte", "java.lang.Integer" },
                classes.toArray());
        ...
        assertTrue(classes
                .contains("com.vaadin.flow.server.frontend.FrontendDependenciesTestComponents$AnotherComponent"));
    ...
    public void should_visitSuperNpmPakageAnnotations() {
        FrontendDependencies deps = getFrontendDependencies(ScannerTestComponents.ComponentExtending.class);
    ...
    public void should_resolveComponentFactories() {
        ...
        DepsTests.assertImportsExcludingUI(deps.getModules(), "./my-component.js", "./my-static-factory.js",
    ...
    public void should_notVisitNonAnnotatredClasses() {
        ...
        assertEquals("Only UI should be found", 1, deps.getEntryPoints().size());
    }
    ...
    public void should_cacheVisitedClasses() {
        ...
        assertTrue("Should cache visited classes", deps.getClasses().size() > 2);
    ...
    public void should_cacheSuperVisitedClasses() {
        List<Class<?>> visited = Arrays.asList(Route.class, NoTheme.class, JsModule.class,
        ...
        assertEquals("Should find RoutedClass and UI", 2, deps.getEntryPoints().size());
        ...
        assertEquals("Should contain UI, RoutedClass and its parent", 3, deps.getEntryPoints().size());
    ...
    public void should_visitDynamicRouteWithTwoImports() {
        FrontendDependencies deps = getFrontendDependencies(DynamicComponentClassWithTwoImports.class);
    ...
    public void should_visitDynamicRoute() {
        ...
        DepsTests.assertImportsExcludingUI(deps.getModules(), "dynamic-component.js", "dynamic-route.js",
                "dynamic-layout.js");
    }
    ...
    public void should_visitMethodAnnotations() {
        FrontendDependencies deps = getFrontendDependencies(MethodAnnotationRoute.class);
    ...
    public @interface UISearchField {
        class SearchFieldComponentDefinitionCreator implements ComponentDefinitionCreator<UISearchField> {
        ...
        public @interface UISearchLayout {
            class SearchLayoutComponentDefinitionCreator implements ComponentDefinitionCreator<UISearchLayout> {
