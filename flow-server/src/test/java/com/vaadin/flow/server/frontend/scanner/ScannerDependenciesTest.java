...
public class ScannerDependenciesTest {
    ...
    public void should_resolveComponentFactories() {
        ...
        DepsTests.assertImports(deps.getModules(), "./my-component.js",
                "./my-static-factory.js", "./my-another-component.js");
    }
    ...
    public void should_visitDynamicRoute() {
        ...
        DepsTests.assertImports(deps.getModules(), "dynamic-component.js",
                "dynamic-route.js", "dynamic-layout.js");
    }
