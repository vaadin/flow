...
public class ElementListenerMap extends NodeMap {
    ...
    public boolean isPropertySynchronized(String propertyName) {
        ...
        Stream<DomEventListenerWrapper> wrappers = listeners.values().stream()
                .flatMap(List::stream);

        Stream<String> expressions = wrappers
        ...
        return expressions.anyMatch(eventDataExpression::equals);
    }
