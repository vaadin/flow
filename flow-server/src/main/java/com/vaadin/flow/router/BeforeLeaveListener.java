 ...
 * <p>
 * All listeners added this way will be informed when old components are detached from the
 * {@link com.vaadin.flow.component.UI}.
 * <p>
 * During this phase there is the possibility to reroute to another navigation target or to postpone the navigation (to
 * for instance get user input).
 * <p>
 ...
 *
 * All BeforeLeaveListeners will be executed before the BeforeLeaveObservers. To control the order of execution of
 * BeforeLeaveListeners, see {@link ListenerPriority}
 *
 * @since 1.0
 */
@FunctionalInterface
