...
/**
 * This annotation sets the priority of execution on {@link BeforeEnterListener}s, {@link BeforeLeaveListener}s and
 * {@link AfterNavigationListener}s. Listeners will be sorted by their respective priority value in a descending order
 * before they are executed. Listeners that are not annotated with {@literal @}ListenerPriority have a default priority
 * of zero.
 *
 * <pre>
