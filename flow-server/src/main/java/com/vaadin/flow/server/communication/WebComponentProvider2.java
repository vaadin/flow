 ...
 * the given tag.
 */
public class WebComponentProvider2 extends SynchronizedRequestHandler {
    ...
    public boolean synchronizedHandleRequest(VaadinSession session,
        ...
        if (!tag.isPresent()) {
            LoggerFactory.getLogger(WebComponentProvider2.class).info(
        ...
        if (optionalWebComponentConfiguration.isPresent()) {
            ...
            if (cache.containsKey(webComponentConfiguration.getExporterClass())) {
                ...
                generated = WebComponentGenerator2.generateModule(uiElement,
