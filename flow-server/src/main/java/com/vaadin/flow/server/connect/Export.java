...
/**
 * Annotation to mark the exports to be processed by
 ...
 * export. This means that the class name and all its public methods (including
...
public @interface Export {
    /**
     * The name of a export to use. If nothing is specified, the name of the
     ...
     * {@link ExportNameChecker} for validation implementation details.
     *
     * @return the name of the export to use in post requests
     */
