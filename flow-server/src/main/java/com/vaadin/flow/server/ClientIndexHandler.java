...
public class ClientIndexHandler extends JavaScriptBootstrapHandler {
    ...
    public boolean synchronizedHandleRequest(VaadinSession session,
        ...
        ClientIndexBootstrapPage page = new ClientIndexBootstrapPage(request,
                response, session, indexDocument, this);

        request.getService().modifyClientIndexBootstrapPage(page);
