...
/**
 * An exception that is intended to be thrown by any Vaadin Connect export
 * method to propagate exception details to the client side. When an exception
 * is thrown by a export method, a particular response is constructed based on
 ...
 * response data.
 *
 * By default, if any Vaadin Connect export method throws an exception when
