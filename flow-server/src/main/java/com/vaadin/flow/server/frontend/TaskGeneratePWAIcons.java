...
public class TaskGeneratePWAIcons implements FallibleCommand {
    ...
    public TaskGeneratePWAIcons(PwaConfiguration pwaConfiguration,
            ClassFinder classFinder, File webappResourcesDirectory) {
        this.pwaConfiguration = pwaConfiguration;
        generatedIconsPath = webappResourcesDirectory.toPath().resolve(
                Paths.get(Constants.VAADIN_WEBAPP, Constants.VAADIN_PWA_ICONS));
            ...
            try {
                ...
                if (cause instanceof UncheckedIOException) {
                    throw new ExecutionFailedException(
                            "PWA icons generation failed", cause.getCause());
                }
                throw new ExecutionFailedException(
    ...
    private void createGeneratedIconsFolder() throws ExecutionFailedException {
        try {
            Path generatedPath = generatedIconsPath
                    .resolve(Paths.get(pwaConfiguration.getIconPath()
