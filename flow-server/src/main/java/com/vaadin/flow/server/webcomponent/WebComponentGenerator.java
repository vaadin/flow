...
public class WebComponentGenerator {
    ...
    private static String getPropertyValues(String codePropertyValues,
        ...
        sync.append("{");
        for (PropertyData<?> property : properties) {
            sync.append(codePropertyValues.replace("_PropertyName_",
                    property.getName()));
            sync.append(",");
        }
    ...
    private static String getAttributeChange(String codeAttributeChange,
        ...
        for (PropertyData<?> property : properties) {
            sync.append(codeAttributeChange
                    .replace("_AttributeName_", property.getAttributeName())
                    .replace("_PropertyName_", property.getName())
                    .replace("_JSType_", property.getJSType()));
        }
        return sync.toString();
    }
    ...
    private static String createPropertyDefault(String code,
        ...
        return code.replace("_PropertyName_", property.getName())
                .replace("_DefaultValue_", getDefaultJsValue(property));
    }
    ...
    private static String createPropertySetterGetter(String codePropertyMethods,
            PropertyData<?> property) {
        return codePropertyMethods.replace("_PropertyName_", property.getName())
                .replace("_ChangeEventName_",
