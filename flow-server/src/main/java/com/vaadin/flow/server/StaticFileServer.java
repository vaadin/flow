...
/**
 * Server for static files. The server should be responsible in identifying and
 * serving the static files, based on the servlet request.
 * 
 * @author Vaadin Ltd.
 * 
 * @see DefaultStaticFileServer
 */
public interface StaticFileServer extends Serializable {
