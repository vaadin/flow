 ...
 * when a fetch query threw, before the matching {@link DataFetchEndedEvent}.
...
public class DataFetchFailedEvent extends AbstractDataFetchEvent {
     ...
     */
    public DataFetchFailedEvent(UI ui, Component component, int offset,
            int limit, boolean filtered, Throwable error) {
