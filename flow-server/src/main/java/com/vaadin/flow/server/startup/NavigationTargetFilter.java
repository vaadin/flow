 ...
 * <p>
 * Listener instances are by discovered and instantiated using {@link ServiceLoader}. This means that all
 * implementations must have a zero-argument constructor and the fully qualified name of the implementation class must
 * be listed on a separate line in a META-INF/services/com.vaadin.flow.server.startup.NavigationTargetFilter file
...
public interface NavigationTargetFilter extends Serializable {
     ...
     * @return <code>true</code> to include the navigation target, <code>false</code> to discard it
     */
     ...
     * @return <code>true</code> to include the error navigation target, <code>false</code> to discard it
     */
