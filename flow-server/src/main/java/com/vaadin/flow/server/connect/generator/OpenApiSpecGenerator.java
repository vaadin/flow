...
public class OpenApiSpecGenerator {
    ...
    public static final String DEFAULT_SERVER_DESCRIPTION = "Vaadin Fusion backend";
    public static final String DEFAULT_APPLICATION_TITLE = "Vaadin Fusion Application";
    ...
    public void generateOpenApiSpec(Collection<Path> sourcesPaths,
        ...
        try {
            if (openAPI.getPaths().size() > 0) {
                ...
                log.info("There are no Fusion endpoints to generate.");
