...
public class ConnectEndpointsValidator
     ...
     *            {@link HandlesTypes} annotation, or <tt>null</tt> if
     *            there are no matches, or this <tt>ServletContainerInitializer</tt>
     *            has not been annotated with <tt>HandlesTypes</tt>
     *
     * @param ctx
