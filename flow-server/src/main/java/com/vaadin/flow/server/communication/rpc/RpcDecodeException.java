 ...
 * <p>
 * It may happen when a decoder supports (applicable) to the type of argument and the required type but the argument
 * value cannot be converted to the type (e.g. "1.1" can't be converted to {@link Integer} even though the
 * {@link StringToNumberDecoder} is able to decode a {@link String} to {@link Integer}).
 * <p>
