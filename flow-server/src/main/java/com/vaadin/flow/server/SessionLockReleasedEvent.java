 ...
 * when a session lock is about to be released.
 *
 * @see SessionLockListener#lockReleased(SessionLockEvent)
 * @since 25.3
 */
public class SessionLockReleasedEvent extends SessionLockEvent {
