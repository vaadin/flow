...
public interface VaadinRequest {
    /**
     * Gets the named request parameter This is typically a HTTP GET or POST parameter, though other request types might
     * have other ways of representing parameters.
     *
     * @see jakarta.servlet.ServletRequest#getParameter(String)
     *
     * @param parameter
     *            the name of the parameter
     * @return The parameter value, or <code>null</code> if no parameter with the given name is present
     */
    ...
    /**
     * Returns an input stream from which the request content can be read. The request content length can be obtained
     * with {@link #getContentLength()} without reading the full stream contents.
     *
     ...
     * @return the value of the attribute, or <code>null</code> if there is no attribute with the given name
     *
    ...
    /**
     * Gets the path of the requested resource relative to the application. The path is <code>null</code> if no path
     * information is available. Does always start with / if the path isn't <code>null</code>.
     *
    ...
    /**
     * Returns the IP address from which the request came. This might also be the address of a proxy between the server
     * and the original requester.
     *
     * @return a string containing the IP address, or <code>null</code> if the address is not available
     *
    ...
    /**
     * Gets the value of a request header, e.g. a http header for a {@link jakarta.servlet.http.HttpServletRequest}.
     *
     * @param headerName
     ...
     * authentication.
     *
     * @return a string indicating the authentication scheme, or <code>null</code> if the request was not authenticated.
     *
     ...
     *
     * @return a String specifying the login of the user making this request, or <code>null</code> if the user login is
     *         not known.
     *
     ...
     * @return a boolean indicating whether the user making this request belongs to a given role; <code>false</code> if
     ...
     * IP address.
     *
     * @return a String containing the fully qualified name of the client, or <code>null</code> if the information is
     *         not available.
     *
     ...
     *
     * @return a String containing the name of the character encoding, or null if the request does not specify a
     *         character encoding
     *
     ...
     *         enumeration; if the implementation does not allow this method, <code>null</code>
     ...
     * <p>
     * If the request did not include any headers of the specified name, this method returns an empty Enumeration. If
     * the request does not support accessing headers, this method returns <code>null</code>.
     * <p>
     ...
     *         that name return an empty enumeration. If the header information is not available, return
     *         <code>null</code>
