 ...
 * <p>
 * This means that any user will be able to trigger an endpoint method (if placed
 * on a endpoint class) or the particular endpoint method (if placed on an endpoint
