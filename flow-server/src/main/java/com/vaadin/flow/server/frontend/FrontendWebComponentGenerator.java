 ...
 *
 * Uses {@link com.vaadin.flow.server.webcomponent.WebComponentModulesWriter} to generate web component modules files
 * from {@link com.vaadin.flow.component.WebComponentExporter} or {@link WebComponentExporterFactory} implementations
 * found by {@link ClassFinder}.
 *
 * <p>
...
public class FrontendWebComponentGenerator implements Serializable {
    ...
    /**
     * Creates a new instances and stores the {@code finder} to be used for locating
     * {@link com.vaadin.flow.server.webcomponent.WebComponentModulesWriter} and
     * {@link com.vaadin.flow.component.WebComponentExporter}/{@link WebComponentExporterFactory} classes.
     *
     * @param finder
     *            {@link com.vaadin.flow.server.frontend.scanner.ClassFinder} implementation
     */
    ...
    /**
     * Collects {@link com.vaadin.flow.server.webcomponent.WebComponentModulesWriter} class and classes that extend
     * {@link com.vaadin.flow.component.WebComponentExporter}/{@link WebComponentExporterFactory} using {@code
    ...
    public Set<File> generateWebComponents(File outputDirectory, ThemeDefinition theme) {
        try {
            final Class<?> writerClass = finder.loadClass(WebComponentModulesWriter.class.getName());
            ...
            return WebComponentModulesWriter.DirectoryWriter.generateWebComponentsToDirectory(writerClass,
