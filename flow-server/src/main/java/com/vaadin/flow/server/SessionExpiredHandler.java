...
public interface SessionExpiredHandler extends RequestHandler {
    ...
    /**
     * Called when the a session expiration has occurred and a notification needs to be sent to the user. If a response
     * is written, this method should return <code>true</code> to indicate that no more {@link SessionExpiredHandler}
