...
import com.vaadin.flow.component.webcomponent.WebComponentUI2;
 ...
 */
public class WebComponentBootstrap2 extends BootstrapHandler {
    ...
    protected BootstrapContext createAndInitUI(Class<? extends UI> uiClass,
        ...
        BootstrapContext context = super.createAndInitUI(WebComponentUI2.class,
