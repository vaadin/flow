...
public class PushConstants implements Serializable {
    ...
    /**
     * The maximum size, in <b>characters</b>, of a websocket message fragment. This is a conservative maximum chosen so
     * that the size in bytes will not exceed {@link PushConstants#WEBSOCKET_BUFFER_SIZE} given a UTF-8 encoded message.
     */
