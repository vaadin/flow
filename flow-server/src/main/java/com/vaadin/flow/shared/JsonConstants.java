...
public class JsonConstants implements Serializable {
    ...
    /**
     * Key of the JavaScript definition in the target object that ends such an
     * invocation in UIDL messages, in place of a JavaScript expression.
     */
    public static final String UIDL_KEY_JS_DEFINITION = "definition";

    /**
     * Key of the invoked method, as its name and argument count, in the target
     * object of a JS invocation of declared JavaScript.
     */
    public static final String UIDL_KEY_JS_DEFINITION_METHOD = "method";
     ...
     */
    public static final String UIDL_KEY_JS_DEFINITION_ARGUMENTS = "arguments";

    /**
     * Key that marks a JS invocation of declared JavaScript whose two last
     * parameters are the channels for its return value.
     */
    public static final String UIDL_KEY_JS_DEFINITION_RETURNS = "returns";
