...
public interface HasEnabled extends HasElement {
    ...
    default void setEnabled(boolean enabled) {
        /*
         * XXX Do not implement this method. Propagating the enabled state to
         * the element in this way is critical to fulfill generic assumptions
         * with regards to application security.
         */
    ...
    default boolean isEnabled() {
        /*
         * XXX Do not implement this method. Reading the enabled state from the
         * element in this way is critical to fulfill generic assumptions with
         * regards to application security.
         */
