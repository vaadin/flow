...
/**
 * Base class for a {@link Component} that represents a single built-in HTML element that can contain child components
 * or text.
 *
 * @author Vaadin Ltd
 * @since 1.0
...
public class HtmlContainer extends HtmlComponent implements HasComponents, HasText {
    /**
     * Creates an empty component with the element determined by the {@link Tag} annotation of a sub class.
     */
    ...
    /**
     * Creates a component with the given child components. The element is determined by the {@link Tag} annotation of a
     * sub class.
     *
     * @param components
