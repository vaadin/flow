 ...
 *
 * The location attribute can be used to disambiguate between key values that can be generated by different physical
 * keys on the keyboard, for example, the left and right Shift key.
 *
 * @since 1.0
 */
public enum KeyLocation {
    ...
    public static KeyLocation of(int location) {
        return Stream.of(values()).filter(l -> l.location == location).findFirst()
