...
public final class PropertyDescriptors {
    ...
    private static final class PropertyDescriptorImpl<S, G> implements PropertyDescriptor<S, G> {
        private String name;
        ...
        private PropertyDescriptorImpl(String name, S defaultValue, BiConsumer<Element, S> setter,
                Consumer<Element> remover, Function<Element, S> getter, BiFunction<S, S, G> returnWrapper) {
            assert name != null;
    ...
    public static PropertyDescriptor<String, String> propertyWithDefault(String name, String defaultValue) {
        return new PropertyDescriptorImpl<>(name, defaultValue, (element, value) -> element.setProperty(name, value),
                element -> element.removeProperty(name), element -> element.getProperty(name, defaultValue),
                nullToDefault());
    }
     ...
     *            the default value of the property, not <code>null</code>
     * @param removeDefault
     *            if {@code true} then attribute with default value will be removed, otherwise attribute with the
     *            default value will be kept as is
     *
     * @return a property descriptor, not <code>null</code>
     */
    public static PropertyDescriptor<String, String> attributeWithDefault(String name, String defaultValue,
    ...
    /**
     * Creates a descriptor for an optional attribute of the component's root element with a non-null default value. The
     * getter will return an empty optional if the element doesn't have the attribute, or if its value is the default
     * value.
     *
     * @param name
     *            the name of the element attribute, not <code>null</code>
    ...
    /**
     * Helper for creating an attribute descriptor with a specific return value wrapper.
     *
     * @param name
     *            the name of the element attribute, not <code>null</code>
     * @param defaultValue
     ...
     *            default value will be kept as is
     * @param returnWrapper
     *            a callback that returns the actual value given the attribute value and the default value
     * @return a property descriptor, not <code>null</code>
     */
    private static <T> PropertyDescriptor<String, T> attribute(String name, String defaultValue, boolean removeDefault,
            BiFunction<String, String, T> returnWrapper) {
        return new PropertyDescriptorImpl<>(name, defaultValue, (element, value) -> element.setAttribute(name, value),
    ...
    /**
     * Creates a return value wrapper that wraps the provided value in an optional, which is empty if the value is the
     * provided default value or <code>null</code>.
     *
    ...
    /**
     * Creates a return value wrapper that returns the default value if the original value is <code>null</code>,
