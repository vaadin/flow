...
public interface HasTheme extends HasElement {
    ...
    /**
     * Adds one or more theme property names to this component. Multiple theme names can be
     * specified by using multiple parameters.
     *
     * @param themeNames the theme property name or theme names to be added to the component
     */
    ...
    /**
     * Removes one or more theme property names from component. Multiple theme names can be
     * specified by using multiple parameters.
     *
     * @param themeNames the theme property name or theme names to be removed from the component
     */
