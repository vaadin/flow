...
/**
 * Acts as a proxy to the web component root onto which the exporter {@link Component} is added. Allows updating web
 * component properties and firing custom events on the client-side.
 *
 * @param <C>
...
public final class WebComponent<C extends Component> implements Serializable {
    ...
    /**
     * Constructs a {@link WebComponent}. {@link WebComponentBinding} provides the instance of the {@link Component}
     * exported as a web component. {@code
     * Binding} also defines the properties the web component has. {@link Element} is the host element which contains
     * the exported {@code
     ...
     * @see com.vaadin.flow.component.webcomponent.WebComponentWrapper for the web component host
     */
    ...
    /**
     * Fires a custom event on the client-side originating from the web component. This event does not bubble in the DOM
     * hierarchy.
     *
     * @param eventName
    ...
    /**
     * Fires a custom event on the client-side originating from the web component with custom event data. This event
     * does not bubble in the DOM hierarchy.
     *
     * @param eventName
     *            name of the event, not null
     * @param objectData
    ...
    /**
     * Fires a custom event on the client-side originating from the web component with custom event data. Allows
     * modifying the default event behavior with {@link EventOptions}.
     *
     * @param eventName
     *            name of the event, not null
     * @param objectData
    ...
    public void fireEvent(String eventName, JsonValue objectData, EventOptions options) {
        ...
        object.put("detail", objectData == null ? Json.createNull() : objectData);

        componentHost.executeJs(String.format(CUSTOM_EVENT, object.toJson()), eventName);
    }

    /**
     * Sets property value on the client-side to the given {@code value}. The required {@link PropertyConfigurationImpl}
     * is received from {@link com.vaadin.flow.component.WebComponentExporter} when a new property is added for the web
     * component.
     *
     * @param propertyConfiguration
     *            identifies the property for which the value is being set, not {@code null}
     * @param value
     *            new value for the property, can be {@code null}
     * @param <P>
     *            type of the property value being set. If the type does not match the original property type, throws an
     *            exception
     * @throws NullPointerException
     ...
     * @throws IllegalArgumentException
     *             if the web component does not have a property identified by {@code propertyConfiguration}
     * @throws IllegalArgumentException
     *             the provided {@code value} is not of the type expected by the property
     */
    ...
    public <P extends Serializable> void setProperty(PropertyConfiguration<C, P> propertyConfiguration, P value) {
        ...
        if (!(propertyConfiguration instanceof PropertyConfigurationImpl)) {
            throw new IllegalArgumentException(
                    String.format("Parameter " + "'propertyConfiguration' is not an implementation of %s",
        ...
        if (!binding.hasProperty(propertyName)) {
            throw new IllegalArgumentException(String.format("%s does not " + "have a property identified by '%s'!",
        ...
        if (value != null && !binding.getPropertyType(propertyName).isAssignableFrom(value.getClass())) {
            throw new IllegalArgumentException(String.format(
                    "Property '%s' " + "of type '%s' cannot be assigned value of type '%s'!", propertyName,
                    binding.getPropertyType(propertyName).getName(), value.getClass().getCanonicalName()));
        }
    ...
    private void setProperty(String propertyName, Object value) {
        ...
        if (value instanceof Integer) {
            componentHost.executeJs(UPDATE_PROPERTY, propertyName, (Integer) value);
        } else if (value instanceof Double) {
            componentHost.executeJs(UPDATE_PROPERTY, propertyName, (Double) value);
        } else if (value instanceof String) {
            componentHost.executeJs(UPDATE_PROPERTY, propertyName, (String) value);
        } else if (value instanceof Boolean) {
            componentHost.executeJs(UPDATE_PROPERTY, propertyName, (Boolean) value);
        } else if (value instanceof JsonValue) {
            // this gets around executeJavaScript limitation.
            // Since properties can take JsonValues, this was needed to allow
            // that expected behavior.
            componentHost.executeJs(String.format(UPDATE_PROPERTY_FORMAT, ((JsonValue) value).toJson()), propertyName);
        }
    }
}
