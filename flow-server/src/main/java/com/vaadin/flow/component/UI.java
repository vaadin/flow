...
public class UI extends Component
    ...
    public Registration addBeforeEnterListener(BeforeEnterListener beforeEnterListener){
        ...
        final Collection<BeforeEnterListener> beforeEnterListeners = internals.getBeforeEnterListeners();
    ...
    public Registration addBeforeLeaveListener(BeforeLeaveListener beforeLeaveListener){
        ...
        final Collection<BeforeLeaveListener> beforeEnterListeners = internals.getBeforeLeaveListeners();

        beforeEnterListeners.add(beforeLeaveListener);
        return () -> beforeEnterListeners.remove(beforeLeaveListener);
    }
}
