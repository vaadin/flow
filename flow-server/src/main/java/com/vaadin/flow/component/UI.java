...
public class UI extends Component
    ...
    private final transient List<BeforeEnterObserver> beforeEnterObservers = new ArrayList<>();

    private final transient List<BeforeLeaveObserver> beforeLeaveObservers = new ArrayList<>();
