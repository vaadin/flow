 ...
 * <p>
 * The default implementations sets the <code>placeholder</code> property for this element. Override all methods in this
 * interface if the placeholder should be set in some other way.
 */
public interface HasPlaceholder extends HasElement {
     ...
     *
     * @return the {@code placeholder} property from the web component. May be null if not yet set.
     */
