...
public final class BundleParser {
    ...
    private static JsonObject getSourceObject(JsonObject module, String name) {
        ...
        if (object == null && validKey(module, CHUNKS, ARRAY)) {
            object = getSourceObjectFromArray(module.getArray(CHUNKS), name);
        }
        if (object == null && validKey(module, NAME, STRING) && validKey(module, SOURCE, STRING)
                && module.getString(NAME).endsWith(name)) {
            object = module;
        }
        return object;
    }
    ...
    private static boolean validKey(JsonObject o, String k, JsonType t) {
        return o != null && o.hasKey(k) && o.get(k).getType().equals(t)
                && (!t.equals(STRING) || !o.getString(k).isEmpty());
    }
