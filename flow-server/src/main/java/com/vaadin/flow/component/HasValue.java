    ...
    default C getComponent() {
        try {
            ...
            throw new ClassCastException(String.format(
                    "The class %1$s implementing %2$s is not a %3$s. It should override the getComponent() method to return the component instance the %1$s is bound to. Original message: %4$s",
