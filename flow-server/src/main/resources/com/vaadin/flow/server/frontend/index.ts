 ...
 * If you want to customize the entry point, you have to copy this file or
 * create your own `index.ts` in your frontend directory.
 * By default, the `index.ts` file should be in `./src/main/frontend/` folder.
 *
 * NOTE:
