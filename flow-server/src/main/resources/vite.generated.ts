...
// The browsers that Vaadin supports: Chrome, Edge and Firefox evergreen,
// Firefox ESR and Safari 17 in its latest minor version. Vite uses this as the
// cssTarget as well, and an ES year would map to browsers that are much older
// than these, which makes Lightning CSS rewrite light-dark() into custom
// properties that only follow the operating system preference.
const target = ['chrome127', 'edge127', 'firefox140', 'safari17.6', 'ios17.6'];
