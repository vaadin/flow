 ...
 *
 * This file has been generated by the `flow:build-frontend` maven goal.
...
const swResourceOutput = "";

const swFileHash = (file) => {
  return crypto.createHash("md5").update(Buffer.from(file)).digest("hex");
};

const swInclude = (manifest, globPattern) => {
  swResourceLocations.forEach((location) => {
