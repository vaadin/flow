...
const serviceWorkerDisabled = false; // to be generated by flow;
...
const isServiceWorkerEnabled = pwaEnabled && !serviceWorkerDisabled;
...
module.exports = {
  ...
  plugins: [
    ...
    isServiceWorkerEnabled && createServiceWorkerPlugin(),
