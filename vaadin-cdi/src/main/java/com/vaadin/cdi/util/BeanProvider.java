...
public final class BeanProvider {
    ...
    public static <T> DependentProvider<T> getDependent(BeanManager beanManager,
     ...
     * aren't managed by CDI. <b>Attention:</b><br/>
    ...
    public static <T> T injectFields(T instance) {
        ...
        InjectionTarget<T> injectionTarget = injectionTargetFactory
    ...
    /**
     * Internal method to resolve the BeanManager via the
     * {@link org.apache.deltaspike.core.api.provider.BeanManagerProvider}.
     *
