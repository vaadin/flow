...
[NOTE]
If you are using https://github.com/vaadin/flow-application-skeleton[`flow-application-skeleton`] as a starting point, you have everything already configured to use any component from `flow-components` jar.
In this case, you can skip to <<Installing the Web Component>>.
If you want to learn how to use any web component in your project, continue reading.
