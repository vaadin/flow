...
If you choose to not use the <<tutorial-routing-router-configuration#,RouterConfiguration>>, you can replace it by setting a handler for navigation events using the
