import { BundlerOutputOptions, VisualizerPlugin } from "./bundler-types.js";
import { Options as OpenOptions } from "open";
import { TemplateType } from "./template-types.js";
import { Filter } from "../shared/create-filter.js";
...
export declare const visualizer: (opts?: PluginVisualizerOptions | ((outputOptions: BundlerOutputOptions) => PluginVisualizerOptions)) => VisualizerPlugin;
