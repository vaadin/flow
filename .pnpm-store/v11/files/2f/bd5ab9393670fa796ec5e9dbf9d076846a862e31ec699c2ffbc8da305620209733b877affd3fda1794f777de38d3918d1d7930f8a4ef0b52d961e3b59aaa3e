...
declare namespace babelCompat_d_exports {
  export { FileResult, InputOptions, PluginObject, PresetItem, loadOptionsAsync };
}
...
type PluginObject<T = babel.PluginPass> = IsAny<PluginObject8<T>> extends false ? PluginObject8<T> : PluginObj<T>;
type FileResult = IsAny<FileResult8> extends false ? FileResult8 : BabelFileResult;
declare const loadOptionsAsync: (options?: InputOptions) => Promise<InputOptions & {
...
export declare function defineRolldownBabelPreset(preset: RolldownBabelPreset): RolldownBabelPreset;
//#endregion
...
//#endregion
export { type RolldownBabelPreset, babelPlugin as default };