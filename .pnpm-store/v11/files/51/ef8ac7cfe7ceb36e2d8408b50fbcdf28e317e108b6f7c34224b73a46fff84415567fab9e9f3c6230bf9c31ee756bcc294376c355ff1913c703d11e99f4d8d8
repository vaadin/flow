...
type EslintConfig = false | {
  ...
  dev?: Partial<{
    /** You can override the options of translated from lintCommand. */overrideConfig: ESLint.Options; /** which level of the diagnostic will be emitted from plugin */
...
type StylelintConfig = false | {
  ...
  lintCommand: string;
  dev?: Partial<{
    /** You can override the options of translated from lintCommand. */overrideConfig: Stylelint.LinterOptions; /** which level of the diagnostic will be emitted from plugin */
    logLevel: ('error' | 'warning')[];
    /**
     * How long to wait (in ms) after a file change before linting,
     * coalescing changes within the window into a single run.
...
type BiomeConfig = boolean | {
  ...
  watchPath?: string | string[];
  dev?: Partial<{
    /** Command will be used in dev mode */command: BiomeCommand; /** Flags of the command */
    flags?: string; /** Which level of the diagnostic will be emitted from plugin */
  ...
  build?: Partial<{
    /** Command will be used in build mode */command: BiomeCommand; /** Flags of the command */
    flags?: string;
  }>;
};
type OxlintConfig = boolean | {
  ...
  watchPath?: string | string[];
  dev?: Partial<{
    /** Specifies which level of the diagnostic will be emitted from the plugin */logLevel: ('error' | 'warning')[];
    /**
     * How long to wait (in ms) after a file change before linting,
     * coalescing changes within the window into a single run.
     * @default 300
