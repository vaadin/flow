...
import ComplexTypeModel from './com/vaadin/fusion/generator/endpoints/complextypes/ComplexTypeEndpoint/ComplexTypeModel';
...
export const ComplexTypeEndpoint = Object.freeze ({
  getComplexTypeModel: _getComplexTypeModel,
});
