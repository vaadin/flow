...
The method `setPerson` is annotated with the `@Exclude` annotation to exclude 
importing of the `id` property whose type is unsupported.   
...
All other properties will be excluded. So in this specific case the 
