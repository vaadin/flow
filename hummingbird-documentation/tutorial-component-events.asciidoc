...
The second constructor parameter is used to let the user know whether the event has been triggered by a DOM even in the browser or indirectly through a server-side API.
