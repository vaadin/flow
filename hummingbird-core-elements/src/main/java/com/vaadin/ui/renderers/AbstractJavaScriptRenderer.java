...
// * will look for a globally defined JavaScript function that will initialize
/// the
// * renderer. The name of the initialization function is formed by replacing .
// * with _ in the name of the server-side class. If no such function is
/// defined,
...
// * server-side
// * <code>com.example.MyRenderer extends AbstractJavaScriptRenderer</code>
/// class.
...
// * <p>
// * The initialization function will be called with <code>this</code> pointing
/// to
// * a connector wrapper object providing integration to Vaadin with the
/// following
// * functions:
// * <ul>
// * <li><code>getRowKey(rowIndex)</code> - Gets a unique identifier for the row
// * at the given index. This identifier can be used on the server to retrieve
/// the
...
// * into the given cell. The structure of cell and data are described in
/// separate
// * sections below. The renderer is required to implement this function.
// * Corresponds to
// * {@link
/// com.vaadin.client.renderers.Renderer#render(com.vaadin.client.widget.grid.RendererCellReference,
/// Object)}
// * .</li>
...
// * .</li>
// * <li><code>onActivate(cell)</code> - Called when the cell is activated by
/// the
...
// * {@link
/// com.vaadin.client.renderers.ComplexRenderer#getConsumedEvents()}.</li>
...
// * {@link
/// com.vaadin.client.renderers.ComplexRenderer#onBrowserEvent(com.vaadin.client.widget.grid.CellReference,
...
// * Readonly.</li>
// * <li><code>columnIndex</code> - The current index of the column of this
/// cell.
// * Readonly.</li>
...
// * @since 7.4
// */
// public abstract class AbstractJavaScriptRenderer<T> extends
/// AbstractRenderer<T> {
// private JavaScriptCallbackHelper callbackHelper = new
