...
public class DataSerializableTest extends ClassesSerializableTest {
    ...
    /*
     * AbstractDataProvider.addDataProviderListener may return a Registration instance that is not deserializable due to
     * self references. This happens for example if the dataprovider, member of a component, is used to add a
     * com.vaadin.flow.data.provider.DataProviderListener into an inner component; the resulting Registration handles a
     * reference to the dataprovider itself that is already referenced by the outer component
     */
    @Test
