...
class ConfigurableFilterDataProviderWrapperTest {
    ...
    public void void_setFilter() {
        ...
        Assertions.assertEquals(1, configurableVoid.size(new Query<>()),
                "Set filter should be used");

        configurableVoid.setFilter(null);

        Assertions.assertEquals(100, configurableVoid.size(new Query<>()),
    ...
    public void predicate_setFilter() {
        ...
        Assertions.assertEquals(49, configurablePredicate.size(new Query<>()),
                "Set filter should be used");

        configurablePredicate.setFilter(null);

        Assertions.assertEquals(100, configurablePredicate.size(new Query<>()),
                "null filter should return all items");
    }
