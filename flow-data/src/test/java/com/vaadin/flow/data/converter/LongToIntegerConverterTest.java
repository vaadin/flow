...
public class LongToIntegerConverterTest {
    ...
    LongToIntegerConverter converter = new LongToIntegerConverter();
    ...
    public void testConvertToModel() {
        Result<Integer> result = converter.convertToModel(42L, null);
        assertEquals(Result.ok(42), result);
    }

    @Test
    public void testConvertToPresentation() {
        Long value = converter.convertToPresentation(42, null);
