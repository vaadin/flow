...
public class HierarchicalCommunicatorDataTest {
    ...
    // private final HierarchicalArrayUpdater arrayUpdater = new
    ...
    // @Test
    // public void
    // expandItem_requestNonOverlappingRange_expandedItemPersistsInKeyMapper() {
    // committedUpdateId = -1;
    ...
    // + " not to be fetched because of max allowed items rule, but it was
    // fetched",
    // communicator.getKeyMapper().get(treeItemId));
    // }
    // });
