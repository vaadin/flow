...
class ListDataProviderTest
    ...
    public void setSortByProperty_ascending() {
        ...
        Assertions.assertArrayEquals(new int[] { 0, 1, 2 }, threeFirstIds);
    }
    ...
    public void setSortByProperty_descending() {
        ...
        Assertions.assertArrayEquals(new int[] { 98, 97, 96 }, threeFirstIds);
    }
    ...
    public void testMultipleSortOrder_firstAddedWins() {
        ...
        // First one is Xyz
        Assertions.assertEquals(new StrBean("Xyz", 10, 100),
                threeFirstItems.get(0));
        // The following are Foos ordered by id
        Assertions.assertEquals(new StrBean("Foo", 93, 2),
                threeFirstItems.get(1));
        Assertions.assertEquals(new StrBean("Foo", 91, 2),
                threeFirstItems.get(2));
    }
    ...
    public void setFilter() {
        ...
        Assertions.assertEquals(36, sizeWithUnfilteredQuery());

        dataProvider.setFilter(item -> !item.getValue().equals("Foo"));

        Assertions.assertEquals(64, sizeWithUnfilteredQuery(),
                "Previous filter should be reset when setting a new one");

        dataProvider.setFilter(null);

        Assertions.assertEquals(100, sizeWithUnfilteredQuery(),
    ...
    public void setFilterEquals() {
        ...
        Assertions.assertEquals(23, sizeWithUnfilteredQuery());
    }
    ...
    public void addFilter_withPreviousFilter() {
        ...
        Assertions.assertEquals(17, sizeWithUnfilteredQuery(),
    ...
    public void addFilter_noPreviousFilter() {
        ...
        Assertions.assertEquals(48, sizeWithUnfilteredQuery());
    }
    ...
    public void addFilter_firstAddedUsedFirst() {
        ...
        dataProvider.addFilter(item -> {
            Assertions.fail("This filter should never be invoked");
            return true;
        });

        Assertions.assertEquals(0, sizeWithUnfilteredQuery());
    }
    ...
    public void combineProviderAndQueryFilters() {
        ...
        Assertions.assertEquals(17, size, "Both filters should be used");
    }
