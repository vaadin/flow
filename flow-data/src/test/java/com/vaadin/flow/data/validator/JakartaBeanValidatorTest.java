...
import com.vaadin.flow.tests.data.bean.jakarta.Address;
import com.vaadin.flow.tests.data.bean.jakarta.BeanToValidate;

public class JakartaBeanValidatorTest extends ValidatorTestBase {
    ...
    public void testInvalidDecimalsFailsInFrench() {
        ...
        JakartaBeanValidator v = validator("decimals");
    ...
    private JakartaBeanValidator validator(String propertyName) {
        return new JakartaBeanValidator(BeanToValidate.class, propertyName);
    }
