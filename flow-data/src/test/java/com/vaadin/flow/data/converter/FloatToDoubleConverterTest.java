...
public class FloatToDoubleConverterTest {
    ...
    public void testConvertToPresentationPositiveInfinity() {
        assertEquals(Float.valueOf(Float.POSITIVE_INFINITY), converter.convertToPresentation(Double.POSITIVE_INFINITY, null));
    }
    ...
    public void testConvertToPresentationNegativeInfinity() {
        assertEquals(Float.valueOf(Float.NEGATIVE_INFINITY), converter.convertToPresentation(Double.NEGATIVE_INFINITY, null));
    }
