 ...
 * <p>
 * A listing component should implement either this interface or {@link HasDataProvider}, but not both.
 *
 * @author Vaadin Ltd
 * @since 1.0.
 *
...
public interface HasFilterableDataProvider<T, F> extends HasItems<T> {
    ...
    /**
     * Sets the data provider and filter converter for this listing. The data provider is queried for displayed items as
     * needed.
     *
     * @param dataProvider
     *            the data provider, not <code>null</code>
     ...
     *            provided data provider, not <code>null</code>
     * @param <C>
     *            the filter type
     */
