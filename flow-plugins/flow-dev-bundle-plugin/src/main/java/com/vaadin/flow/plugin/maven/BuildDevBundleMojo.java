...
public class BuildDevBundleMojo extends AbstractMojo implements PluginAdapterBuild, PluginAdapterBase {
    ...
    public File frontendResourcesDirectory() {
        return new File(projectBasedir, Constants.LOCAL_FRONTEND_RESOURCES_PATH);
    }
    ...
    public File applicationProperties() {
        return new File(projectBasedir, "/src/main/resources/application.properties");
    }
    ...
    public File webpackOutputDirectory() {
        return new File(project.getBuild().getOutputDirectory(), VAADIN_WEBAPP_RESOURCES);
    }
