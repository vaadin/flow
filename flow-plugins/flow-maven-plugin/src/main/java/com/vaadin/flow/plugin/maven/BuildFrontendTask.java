 ...
 * @since 24.6
 */
public class BuildFrontendTask extends FlowModeAbstractTask
    ...
    public BuildFrontendTask(MavenProject project, ClassFinder classFinder,
            Log logger) {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        logInfo("Build frontend completed in " + ms + " ms.");
    }
    ...
    public boolean checkRuntimeDependency(String groupId, String artifactId,
        ...
        Boolean availableAtRuntime = getProjectDependencies()
    ...
    private Map<String, Boolean> getProjectDependencies() {
        return getProject().getArtifacts().stream().collect(Collectors.toMap(
                artifact -> artifact.getGroupId() + ":"
                        + artifact.getArtifactId(),
                artifact -> !artifact.isOptional()
