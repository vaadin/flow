...
public class ArtifactMatcherTest {
    ...
    public void matches_matchEverything_returnsTrue() {
        Artifact artifact = fromString(
                "com.vaadin:vaadin:jar:24.9-SNAPSHOT:compile");
    ...
    public void matches_exactGroup() {
        ...
        Assert.assertTrue(matcher.matches(
                fromString("com.vaadin:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin:flow-server:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(fromString(
                "com.vaadin.demo:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(fromString(
                "org.com.vaadin.demo:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadindemo:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("org.example:vaadin:jar:24.9-SNAPSHOT:compile")));
    }
    ...
    public void matches_wildcardGroup() {
        FrontendScannerConfig.ArtifactMatcher matcher = new FrontendScannerConfig.ArtifactMatcher(
                "com.vaadin.*", null);
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.example:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.demo:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.demo.a:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadin:vaadin:jar:24.9-SNAPSHOT:compile")));
        ...
        Assert.assertTrue(matcher.matches(
                fromString("com.vaadin:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.example.vaadin:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(
                fromString(".vaadin:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("vaadin:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadindemo:vaadin:jar:24.9-SNAPSHOT:compile")));
        ...
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.example:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.example:vaadin:jar:24.9-SNAPSHOT:compile")));
    }
    ...
    public void matches_wildcardArtifact() {
        ...
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.example:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.demo:vaadin-demo:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.demo.a:vaadindemo:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadin:demovaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadin:example:jar:24.9-SNAPSHOT:compile")));

        matcher.setArtifactId("*vaadin");
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.example:vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.demo:demo-vaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertTrue(matcher.matches(fromString(
                "com.vaadin.demo.a:demovaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadin:vaadindemo:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(fromString(
                "com.vaadin:vaadin-demo:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadin:example:jar:24.9-SNAPSHOT:compile")));
    ...
    public void matches_exactArtifact() {
        ...
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadin:demovaadin:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(fromString(
                "com.vaadin:demovaadindemo:jar:24.9-SNAPSHOT:compile")));
        Assert.assertFalse(matcher.matches(
                fromString("com.vaadin:example:jar:24.9-SNAPSHOT:compile")));
