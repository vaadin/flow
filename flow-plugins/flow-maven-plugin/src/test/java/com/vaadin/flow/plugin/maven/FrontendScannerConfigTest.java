...
public class FrontendScannerConfigTest {
    ...
    private static final String TEST_DEPENDENCIES_LIST = """
            ...
            com.vaadin:vaadin-internal:jar:24.9-SNAPSHOT:compile
            com.vaadin:vaadin-core-internal:jar:24.9-SNAPSHOT:compile
            com.vaadin:vaadin-accordion-flow:jar:24.9-SNAPSHOT:compile
            com.vaadin:vaadin-avatar-flow:jar:24.9-SNAPSHOT:compile
            com.vaadin:vaadin-checkbox-flow:jar:24.9-SNAPSHOT:compile
            com.vaadin:flow-server:jar:24.9-SNAPSHOT:compile
            com.vaadin:flow-push:jar:24.9-SNAPSHOT:compile
            ...
            com.vaadin:flow-client:jar:24.9-SNAPSHOT:compile
