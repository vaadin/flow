...
const moduleWeights = {
  ...
  'flow-tests/test-frontend/vite-basics': { pos: 2, weight: 6 },
  ...
  'flow-tests/vaadin-spring-tests/test-spring': { pos: 5, weight: 4 },
  'flow-tests/vaadin-spring-tests/test-spring-security-flow': { pos: 5, weight: 4 },
  ...
  'flow-tests/test-router-custom-context': { weight: 8 },
  'flow-tests/test-pwa-disabled-offline': { weight: 8 },
  'flow-tests/test-eager-bootstrap': { weight: 8 },
  'flow-tests/test-frontend/vite-pwa-disabled-offline': { weight: 7 },
  'flow-tests/test-ccdm-flow-navigation': { weight: 6 },
