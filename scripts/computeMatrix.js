...
const moduleWeights = {
  ...
  'flow-tests/test-commercial-banner': { pos: 7},
  ...
  'flow-tests/test-router-custom-context/pom-encoded-ctx.xml': { weight: 5 },
  'flow-tests/test-router-custom-context/pom-encoded-ctx-production.xml': { weight: 5 },
