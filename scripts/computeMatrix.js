...
const moduleWeights = {
  ...
  'flow-tests/test-frontend/vite-basics': { pos: 2, weight: 7 },
  'flow-tests/test-ccdm-flow-navigation/pom-production.xml': { pos: 2, weight: 3 },
  'flow-tests/test-embedding/test-embedding-production-mode': { pos: 2, weight: 3 },
  ...
  'flow-tests/test-live-reload': { pos: 3, weight: 4 },
  'flow-tests/test-embedding/test-embedding-generic': { pos: 3, weight: 4 },
  ...
  'flow-tests/test-embedding/test-embedding-reusable-theme': { pos: 3, weight: 3 },
  'flow-tests/test-application-theme/test-theme-reusable-vite': { pos: 3, weight: 3 },
  'flow-tests/test-frontend/vite-production': { pos: 3, weight: 3 },
  'flow-tests/test-frontend/vite-production-custom-frontend': { pos: 3, weight: 3 },
  'flow-tests/test-multi-war/deployment': { pos: 3, weight: 2 },
  'flow-tests/test-frontend/vite-test-assets': { pos: 3 },
  'flow-tests/vaadin-spring-tests/test-spring-boot-only-prepare': { pos: 4, weight: 4 },
  ...
  'flow-tests/vaadin-spring-tests/test-spring-boot-reverseproxy': { pos: 4, weight: 3 },
  ...
  'flow-tests/test-ccdm-flow-navigation': { weight: 8 },
  'flow-tests/test-frontend/vite-pwa-disabled-offline': { weight: 6 },
  'flow-tests/test-frontend/vite-pwa': { weight: 6 },
  'flow-tests/test-pwa': { weight: 6 },
  'flow-tests/test-custom-frontend-directory/test-themes-custom-frontend-directory/pom-generatedTsDir.xml': { weight: 6 },
  'flow-tests/test-router-custom-context': { weight: 5 },
  'flow-tests/test-pwa-disabled-offline': { weight: 5 },
  'flow-tests/test-eager-bootstrap': { weight: 5 },
  'flow-tests/test-frontend/vite-embedded': { weight: 4 },
  'flow-tests/test-dev-mode': { weight: 4 },
  'flow-tests/test-custom-frontend-directory/test-themes-custom-frontend-directory': { weight: 4 },
  ...
  'flow-tests/test-frontend/vite-embedded-webcomponent-resync': { weight: 3 },
  ...
  'flow-tests/test-embedding/test-embedding-theme-variant': { weight: 3 },
