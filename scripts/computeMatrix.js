...
const moduleWeights = {
  ...
  'flow-tests/test-express-build/test-parent-theme-express-build/pom-prod.xml': { pos: 1, weight: 2 },
  'flow-tests/test-express-build/test-parent-theme-in-frontend': { pos: 1, weight: 2 },
  'flow-tests/test-express-build/test-parent-theme-in-frontend/pom-prod.xml': { pos: 1, weight: 2 },
