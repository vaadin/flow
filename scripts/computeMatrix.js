...
const moduleWeights = {
  ...
  'flow-tests/test-ccdm-flow-navigation/pom-production.xml': { pos: 2, weight: 6 },
  ...
  'flow-tests/test-frontend/vite-pwa': { weight: 7 },
  ...
  'flow-tests/test-ccdm': { weight: 5 },
  'flow-tests/test-npm-only-features/test-npm-no-buildmojo': { weight: 5 },
  ...
  'flow-tests/test-ccdm/pom-production.xml': { weight: 4 },
  'flow-tests/test-redeployment': { weight: 4 },
  ...
  'flow-tests/test-npm-only-features/test-npm-general': { weight: 3 },
  'flow-tests/test-frontend/vite-pwa-custom-offline-path/pom-production.xml': { weight: 3 },
  'flow-tests/test-frontend/vite-embedded/pom-production.xml': { weight: 3 },
  'flow-tests/test-application-theme/test-theme-dev-bundle': { weight: 2 },
  'flow-tests/test-pwa-disabled-offline/pom-production.xml': { weight: 2 },
