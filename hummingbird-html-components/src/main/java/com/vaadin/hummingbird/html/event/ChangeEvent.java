...
/**
 * Event fired when the value of a component has changed. This event is
 * specifically intended to the <code>change</code> event in the DOM API.
 *
 * @since
 * @author Vaadin Ltd
 */
@DomEvent("change")
public class ChangeEvent extends ComponentEvent {
    /**
