 ...
 */
@Tag("a")
public class Anchor extends HtmlComponentWithContent {
    ...
    /**
     * Sets the URL that this anchor should link to.
     *
     * @param href
    ...
    /**
     * Sets the relationship between the current page an the link target. The
     * value should be a space-separated list of known tokens.
     *
     * @see <a href="https://www.w3.org/TR/html5/links.html#linkTypes">Link
     *      types in the HTML specification</a>
     *
     * @param rel
     *            a space-separated list of relationship tokens, or
     *            <code>null</code> to remove all relationships
     */
    ...
    /**
     * Gets the relationship between the current page and the link target.
     *
     * @see #setRel(String)
     *
