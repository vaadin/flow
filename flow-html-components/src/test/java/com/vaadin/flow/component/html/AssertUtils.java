...
class AssertUtils {
     ...
     *
     * If both <code>expected</code> and <code>actual</code> are arrays or are <code>Optional</code>s wrapping arrays,
     * <code>Assert#assertArrayEquals</code> is used to assert that the arrays content is equal.
     *
     * @param message
