...
public abstract class GeneratedVaadinContextMenuOverlay<R extends GeneratedVaadinContextMenuOverlay<R>>
     ...
     * </p>
     * <p>
     * Custom function for rendering the content of the overlay. Receives three
     * arguments:
     * </p>
     * <ul>
     * <li>{@code root} The root container DOM element. Append your content to
     * it.</li>
     * <li>{@code owner} The host element of the renderer function.</li>
     * <li>{@code model} The object with the properties related with rendering.
     * <p>
     * This property is not synchronized automatically from the client side, so
     ...
     * it.</li>
     * <li>{@code owner} The host element of the renderer function.</li>
     * <li>{@code model} The object with the properties related with rendering.</li>
     * </ul>
     * 
     * @param renderer
     *            the JsonObject value to set
    ...
    public static class VaadinOverlayCloseEvent<R extends GeneratedVaadinContextMenuOverlay<R>>
    ...
    public static class VaadinOverlayEscapePressEvent<R extends GeneratedVaadinContextMenuOverlay<R>>
            extends ComponentEvent<R> {
    ...
    public static class VaadinOverlayOpenEvent<R extends GeneratedVaadinContextMenuOverlay<R>>
            extends ComponentEvent<R> {
    ...
    public static class VaadinOverlayOutsideClickEvent<R extends GeneratedVaadinContextMenuOverlay<R>>
            extends ComponentEvent<R> {
    ...
    public static class OpenedChangeEvent<R extends GeneratedVaadinContextMenuOverlay<R>>
            extends ComponentEvent<R> {
    ...
    public static class TemplateChangeEvent<R extends GeneratedVaadinContextMenuOverlay<R>>
            extends ComponentEvent<R> {
    ...
    public static class ContentChangeEvent<R extends GeneratedVaadinContextMenuOverlay<R>>
            extends ComponentEvent<R> {
