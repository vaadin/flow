 ...
 * {@code <vaadin-select-overlay>} parts.
 * </p>
 * <p>
 * See <a
...
@Generated({"Generator: com.vaadin.generator.ComponentGenerator#1.2-SNAPSHOT",
		"WebComponent: Vaadin.SelectOverlayElement#UNKNOWN",
		"Flow#1.2-SNAPSHOT"})
@Tag("vaadin-select-overlay")
@HtmlImport("frontend://bower_components/vaadin-select/src/vaadin-select-overlay.html")
public abstract class GeneratedVaadinSelectOverlay<R extends GeneratedVaadinSelectOverlay<R>>
		extends
	...
	public static class VaadinOverlayCloseEvent<R extends GeneratedVaadinSelectOverlay<R>>
			extends
				ComponentEvent<R> {
	...
	public static class VaadinOverlayEscapePressEvent<R extends GeneratedVaadinSelectOverlay<R>>
			extends
				ComponentEvent<R> {
	...
	public static class VaadinOverlayOpenEvent<R extends GeneratedVaadinSelectOverlay<R>>
			extends
				ComponentEvent<R> {
	...
	public static class VaadinOverlayOutsideClickEvent<R extends GeneratedVaadinSelectOverlay<R>>
			extends
				ComponentEvent<R> {
	...
	public static class OpenedChangeEvent<R extends GeneratedVaadinSelectOverlay<R>>
			extends
				ComponentEvent<R> {
	...
	protected Registration addOpenedChangeListener(
		...
		return getElement().addPropertyChangeListener(
				"opened",
				event -> listener.onComponentEvent(new OpenedChangeEvent<R>(
						(R) this, event.isUserOriginated())));
	}

	public static class TemplateChangeEvent<R extends GeneratedVaadinSelectOverlay<R>>
			extends
				ComponentEvent<R> {
	...
	protected Registration addTemplateChangeListener(
		...
		return getElement().addPropertyChangeListener(
				"template",
				event -> listener.onComponentEvent(new TemplateChangeEvent<R>(
						(R) this, event.isUserOriginated())));
	}

	public static class ContentChangeEvent<R extends GeneratedVaadinSelectOverlay<R>>
			extends
				ComponentEvent<R> {
	...
	protected Registration addContentChangeListener(
		...
		return getElement().addPropertyChangeListener(
				"content",
				event -> listener.onComponentEvent(new ContentChangeEvent<R>(
						(R) this, event.isUserOriginated())));
	}
}