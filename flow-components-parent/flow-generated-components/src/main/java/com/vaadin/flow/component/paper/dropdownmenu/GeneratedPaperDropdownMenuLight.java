 ...
 * the License.
 */
package com.vaadin.flow.component.paper.dropdownmenu;
...
public abstract class GeneratedPaperDropdownMenuLight<R extends GeneratedPaperDropdownMenuLight<R>>
     ...
     */
    protected boolean hasContentBoolean() {
