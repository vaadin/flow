 ...
 * 
 * {@code <fade-in-animation>} animates the opacity of an element from 0 to 1.
 * 
 * Configuration: {@code }` { name: 'fade-in-animation', node: <node> timing:
 * <animation-timing> } {@code }`
 */
@Generated({
		"Generator: com.vaadin.generator.ComponentGenerator#0.1.11-SNAPSHOT",
		"WebComponent: fade-in-animation#UNKNOWN", "Flow#0.1.11-SNAPSHOT"})
