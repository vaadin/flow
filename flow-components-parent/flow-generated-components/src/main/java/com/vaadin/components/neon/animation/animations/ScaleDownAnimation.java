 ...
 * 
 * {@code <scale-down-animation>} animates the scale transform of an element
 * from 1 to 0. By default it scales in both the x and y axes.
 * 
 * Configuration: {@code }` { name: 'scale-down-animation', node: <node>, axis:
 * 'x' | 'y' | '', transformOrigin: <transform-origin>, timing:
 * <animation-timing> } {@code }`
 */
@Generated({
		"Generator: com.vaadin.generator.ComponentGenerator#0.1.11-SNAPSHOT",
		"WebComponent: scale-down-animation#UNKNOWN", "Flow#0.1.11-SNAPSHOT"})
