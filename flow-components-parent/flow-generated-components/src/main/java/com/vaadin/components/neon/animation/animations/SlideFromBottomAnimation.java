 ...
 * 
 * {@code <slide-from-bottom-animation>} animates the transform of an element
 * from {@code none} to {@code translateY(100%)}. The {@code transformOrigin}
 * defaults to {@code 50% 0}.
 * 
 * Configuration: {@code }` { name: 'slide-from-bottom-animation', node: <node>,
