...
import com.vaadin.components.paper.menu.button.PaperMenuShrinkHeightAnimation;
...
public class PaperMenuShrinkHeightAnimation extends Component
		implements
			HasStyle {
	 ...
	 */
	protected <R extends PaperMenuShrinkHeightAnimation> R getSelf() {
		return (R) this;
	}
}