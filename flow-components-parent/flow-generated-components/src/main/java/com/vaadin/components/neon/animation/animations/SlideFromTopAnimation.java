 ...
 * 
 * {@code <slide-from-top-animation>} animates the transform of an element from
 * {@code translateY(-100%)} to {@code none}. The {@code transformOrigin}
 * defaults to {@code 50% 0}.
 * 
 * Configuration: {@code }` { name: 'slide-from-top-animation', node: <node>,
