...
import com.vaadin.components.paper.dropdown.menu.PaperDropdownMenu;
...
@Generated({
		...
		"WebComponent: paper-dropdown-menu#2.0.0", "Flow#0.1.13-SNAPSHOT"})
...
public class PaperDropdownMenu extends Component implements HasStyle {
	...
	public static class ActiveChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public ActiveChangedEvent(PaperDropdownMenu source, boolean fromClient) {
	...
	public static class FocusedChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public FocusedChangedEvent(PaperDropdownMenu source, boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class DisabledChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public DisabledChangedEvent(PaperDropdownMenu source, boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class IronFormElementRegisterEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public IronFormElementRegisterEvent(PaperDropdownMenu source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class IronFormElementUnregisterEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public IronFormElementUnregisterEvent(PaperDropdownMenu source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class ValueChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public ValueChangedEvent(PaperDropdownMenu source, boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class InvalidChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public InvalidChangedEvent(PaperDropdownMenu source, boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class SelectedItemLabelChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public SelectedItemLabelChangedEvent(PaperDropdownMenu source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class SelectedItemChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public SelectedItemChangedEvent(PaperDropdownMenu source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class OpenedChangedEvent
			extends
				ComponentEvent<PaperDropdownMenu> {
		public OpenedChangedEvent(PaperDropdownMenu source, boolean fromClient) {
			super(source, fromClient);
		}
	}
