...
@Generated({
		...
		"WebComponent: paper-dropdown-menu-light#2.0.0", "Flow#0.1.12-SNAPSHOT"})
...
public class PaperDropdownMenuLight<R extends PaperDropdownMenuLight<R>>
	...
	public static class ActiveChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public ActiveChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
	...
	public static class FocusedChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public FocusedChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class DisabledChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public DisabledChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class IronFormElementRegisterEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public IronFormElementRegisterEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class IronFormElementUnregisterEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public IronFormElementUnregisterEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class ValueChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public ValueChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class InvalidChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public InvalidChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class SelectedItemLabelChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public SelectedItemLabelChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class SelectedItemChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public SelectedItemChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class OpenedChangedEvent
			extends
				ComponentEvent<PaperDropdownMenuLight> {
		public OpenedChangedEvent(PaperDropdownMenuLight source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
