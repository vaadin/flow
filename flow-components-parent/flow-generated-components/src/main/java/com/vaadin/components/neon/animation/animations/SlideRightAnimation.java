...
import com.vaadin.components.neon.animation.animations.SlideRightAnimation;

/**
 * Description copied from corresponding location in WebComponent:
 * 
 * {@code <slide-right-animation>} animates the transform of an element from
 * {@code none} to {@code translateX(100%)}. The {@code transformOrigin}
 * defaults to {@code 0 50%}.
 * 
 * Configuration: {@code }` { name: 'slide-right-animation', node: <node>,
 * transformOrigin: <transform-origin>, timing: <animation-timing> } {@code }`
 */
@Generated({
		"Generator: com.vaadin.generator.ComponentGenerator#0.1.13-SNAPSHOT",
		"WebComponent: slide-right-animation#UNKNOWN", "Flow#0.1.13-SNAPSHOT"})
@Tag("slide-right-animation")
@HtmlImport("frontend://bower_components/neon-animation/animations/slide-right-animation.html")
public class SlideRightAnimation extends Component implements HasStyle {
	 ...
	 */
	public <R extends SlideRightAnimation> R setAnimationTiming(
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends SlideRightAnimation> R setIsNeonAnimation(
	 ...
	 */
	protected <R extends SlideRightAnimation> R getSelf() {
		return (R) this;
	}
}