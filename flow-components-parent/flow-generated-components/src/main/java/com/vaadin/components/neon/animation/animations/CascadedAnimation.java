 ...
 * 
 * {@code <cascaded-animation>} applies an animation on an array of elements
 * with a delay between each. the delay defaults to 50ms.
 * 
 * Configuration: {@code }` { name: 'cascaded-animation', animation:
 * <animation-name>, nodes: <array-of-nodes>, nodeDelay: <node-delay-in-ms>,
