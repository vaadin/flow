...
public class GeneratedVaadinComboBox extends Component implements HasStyle {
	...
	public static class InvalidChangedEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public InvalidChangedEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
	...
	public static class IronFormElementRegisterEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public IronFormElementRegisterEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class IronFormElementUnregisterEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public IronFormElementUnregisterEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class ValueChangedEvent
		...
		public ValueChangedEvent(GeneratedVaadinComboBox source,
				boolean fromClient,
	...
	public static class VaadinDropdownClosedEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public VaadinDropdownClosedEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class VaadinDropdownOpenedEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public VaadinDropdownOpenedEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class OpenedChangedEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public OpenedChangedEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class FilterChangedEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public FilterChangedEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class SelectedItemChangedEvent
		...
		public SelectedItemChangedEvent(
				GeneratedVaadinComboBox source,
				boolean fromClient,
				@EventData("event.detail") elemental.json.JsonObject detail,
	...
	public static class ChangeEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public ChangeEvent(GeneratedVaadinComboBox source, boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class CustomValueSetEvent
		...
		public CustomValueSetEvent(GeneratedVaadinComboBox source,
				boolean fromClient,
	...
	public static class FocusedChangedEvent
			extends
				ComponentEvent<GeneratedVaadinComboBox> {
		public FocusedChangedEvent(GeneratedVaadinComboBox source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
