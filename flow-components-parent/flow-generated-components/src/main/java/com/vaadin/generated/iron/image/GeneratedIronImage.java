...
import com.vaadin.generated.iron.image.GeneratedIronImage;
...
@Generated({
		...
		"WebComponent: iron-image#2.1.2", "Flow#0.1.14-SNAPSHOT"})
@Tag("iron-image")
...
public class GeneratedIronImage extends Component implements HasStyle {
	 ...
	 */
	public <R extends GeneratedIronImage> R setSrc(java.lang.String src) {
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setAlt(java.lang.String alt) {
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setCrossorigin(
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setPreventLoad(boolean preventLoad) {
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setSizing(java.lang.String sizing) {
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setPosition(
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setPreload(boolean preload) {
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setPlaceholder(
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setFade(boolean fade) {
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setWidth(double width) {
	 ...
	 * @return this instance, for method chaining
	 */
	public <R extends GeneratedIronImage> R setHeight(double height) {
		getElement().setProperty("height", height);
		return getSelf();
	}

	@DomEvent("loaded-changed")
	public static class LoadedChangedEvent
			extends
				ComponentEvent<GeneratedIronImage> {
		public LoadedChangedEvent(GeneratedIronImage source, boolean fromClient) {
	...
	public static class LoadingChangedEvent
			extends
				ComponentEvent<GeneratedIronImage> {
		public LoadingChangedEvent(GeneratedIronImage source, boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class ErrorChangedEvent
			extends
				ComponentEvent<GeneratedIronImage> {
		public ErrorChangedEvent(GeneratedIronImage source, boolean fromClient) {
			super(source, fromClient);
		}
	}
