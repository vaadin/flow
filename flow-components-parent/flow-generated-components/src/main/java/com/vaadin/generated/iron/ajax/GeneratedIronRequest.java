 ...
 * the License.
 */
package com.vaadin.generated.iron.ajax;
...
import com.vaadin.generated.iron.ajax.GeneratedIronRequest;
...
@Generated({
		...
		"WebComponent: iron-request#2.0.2", "Flow#0.1.14-SNAPSHOT"})
@Tag("iron-request")
@HtmlImport("frontend://bower_components/iron-ajax/iron-request.html")
public class GeneratedIronRequest extends Component implements HasStyle {
	 ...
	 */
	public <R extends GeneratedIronRequest> R setSucceeded(
	 ...
	 * @see SendOptions
	 * @param options
	 *            url The url to which the request is sent. method The HTTP
	 *            method to use, default is GET. async By default, all requests
	 *            are sent asynchronously. To send synchronous requests, set to
	 *            false. body The content for the request body for POST method.
	 *            headers HTTP request headers. handleAs The response type.
	 *            Default is 'text'. withCredentials Whether or not to send
	 *            credentials on the request. Default is false. timeout:
	 *            (Number|undefined)
	 ...
	 * {@link GeneratedIronRequest#send(SendOptions)} method.
	 */
	...
	public static class XhrChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public XhrChangedEvent(GeneratedIronRequest source, boolean fromClient) {
	...
	public static class ResponseChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public ResponseChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class StatusChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public StatusChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class StatusTextChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public StatusTextChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class CompletesChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public CompletesChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class ProgressChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public ProgressChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class AbortedChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public AbortedChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class ErroredChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public ErroredChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	...
	public static class TimedOutChangedEvent
			extends
				ComponentEvent<GeneratedIronRequest> {
		public TimedOutChangedEvent(GeneratedIronRequest source,
				boolean fromClient) {
			super(source, fromClient);
		}
	}
	 ...
	 */
	protected <R extends GeneratedIronRequest> R getSelf() {
		return (R) this;
	}
}