...
public class AppResource404 extends TestBase {
    ...
    protected void setup() {
        ...
        add(new Link("Existing resource", resource));
        add(new Link("Non-existing resource",
                new ExternalResource(baseUrl + "/APP/connector/0/4/asdfasdf")));
        add(new Link("/APP/ url that should give 404",
                new ExternalResource(baseUrl + "/APP/")));
        add(new Link("/APPLE url that should go to UI providers",
