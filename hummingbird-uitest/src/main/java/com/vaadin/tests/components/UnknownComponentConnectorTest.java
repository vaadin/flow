...
public class UnknownComponentConnectorTest extends MultiBrowserTest {
    ...
    public void testConnectorNotFoundInWidgetset() throws Exception {
        ...
        assertTrue(component.getText().startsWith("Widgetset 'com.vaadin.DefaultWidgetSet' does not contain " + "implementation for com.vaadin.tests.components.UnknownComponentConnector." + "ComponentWithoutConnector."));
    }
}
