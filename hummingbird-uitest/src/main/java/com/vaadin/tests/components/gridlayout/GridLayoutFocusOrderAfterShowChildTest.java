...
public class GridLayoutFocusOrderAfterShowChildTest extends MultiBrowserTest {
    ...
    @Test
    public void showComponentBreaksFocusOrderFirst() throws IOException, Exception {
        openTestURL();
    ...
    @Test
    public void showComponentBreaksFocusOrderMiddle() throws IOException, Exception {
        openTestURL();
    ...
    @Test
    public void showComponentBreaksFocusOrderLast() throws IOException, Exception {
        openTestURL();
