...
public class TestTooSmallSubwindowSize extends AbstractTestUI {
    ...
    private Window createNonResizableWindow() {
        ...
        Label desc = new Label("This is a new child window with a preset" + " width, height and position. Resizing has been" + " disabled for this window. Additionally, this text label" + " is intentionally too large to fit the window. You can" + " use the scrollbars to view different parts of the window content.");
    ...
    private Window createResizableWindow() {
        ...
        Label desc = new Label("This is a new child window with a preset" + " width, height and position. Resizing has not been" + " disabled for this window. Additionally, this text label" + " is intentionally too large to fit the window. You can resize or" + " use the scrollbars to view different parts of the window content.");
        layout.addComponent(desc);
    ...
    private Window createResizableWindowWithHorizontalScrollbar() {
        ...
        layout.setMargin(true);
        Window w = new Window("Resize", layout);
        Label desc = new Label("This is a new child window with a preset" + " width, height and position. Resizing has not been" + " disabled for this window. Additionally, this text label" + " is intentionally too large to fit the window. You can resize" + " to view different parts of the window content.");
        // disable wrapping
        desc.setSizeUndefined();
        layout.addComponent(desc);
