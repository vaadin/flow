...
public class DisabledInlineDateFieldTest extends MultiBrowserTest {
    ...
    private void testDaySelection(String cssClass) {
        ...
        WebElement nonSelectedDay = driver.findElement(By.cssSelector(cssClass + " .v-inline-datefield-calendarpanel-day"));
    ...
    private String getSelectedMonth(String selectorPrefix) {
        return driver.findElement(By.cssSelector(selectorPrefix + " .v-inline-datefield-calendarpanel-month")).getText();
    }
