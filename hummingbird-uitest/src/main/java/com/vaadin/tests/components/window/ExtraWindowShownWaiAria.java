...
public class ExtraWindowShownWaiAria extends AbstractTestUI {
    ...
    protected void setup(VaadinRequest request) {
        ...
        final CheckBox tabStop = new CheckBox("Prevent leaving window with Tab key");
        ...
        final TextField topTabStopMessage = new TextField("Top Tab Stop Message");
        final TextField bottomTabStopMessage = new TextField("Bottom Tab Stop Message");
