...
public class BoundElementTemplate extends AbstractElementTemplate {
	...
	public BoundElementTemplate(String tag, Collection<AttributeBinding> attributeBindings,
	...
	public Collection<String> getAttributeNames(StateNode node) {
		...
		return Collections.unmodifiableCollection(
				Stream.concat(Stream.concat(superAttributes.stream(), attributeBindings.keySet().stream()),
						defaultAttributeValues.keySet().stream()).collect(Collectors.toSet()));
	}
