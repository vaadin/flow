...
public class IfElementTemplate extends BoundElementTemplateWithChildren {
    ...
    public IfElementTemplate(String tag,
        ...
        trueChildren.forEach(c -> c
                .setParentResolver(createParentResolver(true)));
        falseChildren.forEach(c -> c
                .setParentResolver(createParentResolver(false)));
    }
