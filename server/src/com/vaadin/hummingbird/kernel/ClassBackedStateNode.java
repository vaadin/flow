...
public abstract class ClassBackedStateNode extends StateNode {
    ...
    private static Class<? extends ClassBackedStateNode> createMapping(
        ...
        FieldValueTarget<ClassBackedStateNode> buddy = new ByteBuddy()
                ...
                .defineMethod("getFieldMap", Map.class,
                        Collections.emptyList(), Visibility.PUBLIC)
        ...
        for (Entry<Object, Class<?>> entry : explicitTypes.entrySet()) {
            ...
            buddy = buddy
                    .defineField(name, entry.getValue(), Visibility.PUBLIC);
        }

        Class<? extends ClassBackedStateNode> type = buddy
                .make()
