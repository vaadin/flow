...
public class AbsFieldValidatorsTest {
    ...
    public void validatorShouldMakeImmediate() {
        assertFalse("field should not be immediate by default", field.isImmediate());
        field.addValidator(validator);
        assertTrue("field should be immediate when it has a validator", field.isImmediate());
    }
    ...
    public void nonImmediateFieldWithValidator() {
        ...
        field.addValidator(validator);
        assertFalse("field should be non-immediate because explicitly set", field.isImmediate());
    }
    ...
    public void removeValidatorMakesNonImmediate() {
        field.addValidator(validator);
        field.removeValidator(validator);
        assertFalse("field should be non-immediate after validator was removed", field.isImmediate());
    }
    ...
    public void requiredMakesImmediate() {
        ...
        assertTrue("field should be immediate when it is required", field.isImmediate());
    }
    ...
    public void removeRequiredMakesNonImmediate() {
        ...
        assertFalse("field should not be immediate even though it was required", field.isImmediate());
    }
