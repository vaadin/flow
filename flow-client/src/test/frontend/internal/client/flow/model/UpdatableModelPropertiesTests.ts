// Beyond the Java suite: UpdatableModelProperties has no Java test class in src/test/java
// or src/test-gwt/java, so every case here is beyond the Java suite.
