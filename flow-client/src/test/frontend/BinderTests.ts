...
class IdEntityModel<T extends IdEntity> extends ObjectModel<T> {
...
class ProductModel<T extends Product> extends IdEntityModel<T> {
...
class CustomerModel<T extends Customer> extends IdEntityModel<T> {
...
class OrderModel<T extends Order> extends IdEntityModel<T> {
  static createEmptyValue: () => Order;
  readonly customer = new CustomerModel(this, 'customer', CustomerModel.createEmptyValue);
