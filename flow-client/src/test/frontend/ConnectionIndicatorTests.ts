...
suite('ConnectionIndicator', () => {
  let connectionIndicator: ConnectionIndicator;

  suite('properties', () => {
    beforeEach(async () => {
      connectionIndicator =
        document.createElement('vaadin-connection-indicator') as ConnectionIndicator;
    ...
    test('should remove css if default theme not applied', () => {
      connectionIndicator.applyDefaultTheme = false;
      const style = document.querySelector('#css-loading-indicator');
      assert.isNull(style);
    });

    test('should remove css when removed from dom', () => {
      connectionIndicator.remove();
      const style = document.querySelector('#css-loading-indicator');
      assert.isNull(style);
  ...
  suite('with state store', () => {
    ...
    test('initial state: connected', async() => {
      try {
    ...
    test('initial state: reconnecting', async() => {
      try {
    ...
    test('initial state: connection lost', async() => {
      try {
    ...
    test('should react on store state change', async () => {
      try {
        await setupIndicator();
    ...
    test('should not react on store state change after removed from DOM', async () => {
      await setupIndicator();
      connectionIndicator.remove();
