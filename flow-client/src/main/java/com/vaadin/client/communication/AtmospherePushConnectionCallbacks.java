...
/**
 * Adapter handed to the TypeScript {@code AtmospherePushConnection} so it can
 * reach back into still-Java services and sibling TS communication classes
 * without depending on the {@link com.vaadin.client.Registry} facade.
 *
 * <p>
...
public final class AtmospherePushConnectionCallbacks {
    ...
    @JsProperty(name = "getURIResolver")
    public native void setGetURIResolver(JsObjectSupplier supplier);
