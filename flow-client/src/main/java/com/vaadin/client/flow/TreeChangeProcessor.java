...
public class TreeChangeProcessor {
    ...
    private static void setValueInsideListIfApplicable(StateNode node,
        ...
        if (parent == null
                ...
                || parent.getNodeData(UpdatableModelProperties.class) == null) {
            return;
        }
    ...
    private static void updatePropertyInsideList(StateNode parent,
        ...
        UpdatableModelProperties updatableModelProperties = parent
                .getNodeData(UpdatableModelProperties.class);

        if (!updatableModelProperties.isUpdatableProperty(parentPropertyName)
                || !(parentProperty.getValue() instanceof StateNode)) {
            return;
        }
        ...
        NativeFunction setValueFunction = NativeFunction.create("path", "value",
                "this.set(path, value)");
        setValueFunction.call(parent.getDomNode(), path.toString(),
