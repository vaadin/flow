 ...
 * {@link com.vaadin.flow.template.angular.TextTemplateNode} received from the
 * server. The properties are based on the output of
 * {@link com.vaadin.flow.template.angular.TextTemplateNode#populateJson(JsonObject)}
 * on the server.
 *
 * @author Vaadin Ltd
 */
...
public interface TextTemplateNode extends TemplateNode {
     ...
     */
    @JsProperty(name = com.vaadin.flow.template.angular.TextTemplateNode.BINDING_KEY)
