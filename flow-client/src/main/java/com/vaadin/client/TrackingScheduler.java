...
public class TrackingScheduler extends SchedulerImpl {
    ...
    /**
     * Keeps track of if there are deferred commands that are being executed. 0 == no deferred commands currently in
     ...
     *
     * @return true if there is work queued or if work is currently being executed, false otherwise
     */
