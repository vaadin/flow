...
public class ApplicationConnection {
    ...
    public ApplicationConnection(
        ...
        publishClient(applicationConfiguration);

        if (!applicationConfiguration.isProductionMode()) {
            Console.debug("Vaadin application servlet version: "
    ...
    /**
     * Hands this application connection and its configuration to the TypeScript
     * code that publishes the client API object on
     * {@code window.Vaadin.Flow.clients[appId]} (see {@code publishClient.ts}).
     * The published object delegates to the exported methods of this instance.
     *
     * @param configuration
     *            the application configuration
     */
    private native void publishClient(ApplicationConfiguration configuration)
    /*-{
        $wnd.Vaadin.Flow.internal.publishClient(this, configuration);
    }-*/;
