...
public class ElementUtil {
    ...
    /**
     * Searches the shadow root of the given context element for the given id or searches the light DOM if the element
     * has no shadow root.
     *
     * @param context
     ...
     * @return the element with the given {@code id} if found, otherwise <code>null</code>
     */
