 ...
 *
 * This replaces the JSNI `publishJavascriptMethods` /
 * `publishDevelopmentModeJavascriptMethods` blocks of
 * `com.vaadin.client.ApplicationConnection`: it delegates to the methods of the
 * `ApplicationConnection` instance, which `ApplicationConnection.create` passes
 * in once the registry is assembled.
 */
