 ...
 */
export interface PushConnectionFactory {
  /**
   * Creates a new {@link PushConnection} instance for the given `registry`.
   *
   * @param registry - the global registry
   * @returns the push connection instance
   */
  create(registry: unknown): PushConnection;
}
