...
import { DependencyLoader } from './client/DependencyLoader';
import { ResourceLoadEvent, ResourceLoader } from './client/ResourceLoader';
...
import { Binder } from './client/flow/binding/Binder';
...
import { TextBindingStrategy } from './client/flow/binding/TextBindingStrategy';
...
export function installGwtBridge(): void {
  ...
  registerGwtBridge('client', 'DependencyLoader', DependencyLoader);
  registerGwtBridge('client', 'ResourceLoader', ResourceLoader);
  registerGwtBridge('client', 'ResourceLoadEvent', ResourceLoadEvent);
  ...
  registerGwtBridge('client.flow.binding', 'Binder', Binder);
  ...
  registerGwtBridge('client.flow.binding', 'TextBindingStrategy', TextBindingStrategy);
