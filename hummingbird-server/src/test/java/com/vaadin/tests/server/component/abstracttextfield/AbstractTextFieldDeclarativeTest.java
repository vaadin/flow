...
public class AbstractTextFieldDeclarativeTest extends DeclarativeTestBase<AbstractTextField> {
    ...
    public void testAttributes() {
        String design = "<v-text-field null-representation=this-is-null " + "null-setting-allowed='' maxlength=5 columns=3 " + "input-prompt=input text-change-event-mode=eager " + "text-change-timeout=100 />";
