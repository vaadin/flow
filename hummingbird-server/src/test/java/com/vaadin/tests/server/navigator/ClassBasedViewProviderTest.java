...
public class ClassBasedViewProviderTest extends TestCase {
    ...
    public void testViewNameGetter() throws Exception {
        ...
        assertEquals("View name does not match", "test", provider2.getViewName());
    }
    ...
    public void testViewClassGetter() throws Exception {
        ...
        assertEquals("Incorrect view class returned by getter", TestView.class, provider.getViewClass());
    }

    public void testGetViewNameForNullString() throws Exception {
        ClassBasedViewProvider provider = new ClassBasedViewProvider("test", TestView.class);
        assertNull("Received view name for null view string", provider.getViewName((String) null));
    }
