...
public class StringToLongConverterTest extends TestCase {
    ...
    Converter<Long, String> reverseConverter = new ReverseConverter<Long, String>(converter);
    ...
    public void testValueConversion() {
        assertEquals(Long.valueOf(10), converter.convertToModel("10", Long.class, null));
    }

    public void testReverseValueConversion() {
        assertEquals(reverseConverter.convertToModel(10L, String.class, null), "10");
    }

    public void testExtremeLongValueConversion() {
        long l = converter.convertToModel("9223372036854775807", Long.class, null);
    ...
    public void testExtremeReverseLongValueConversion() {
        String str = reverseConverter.convertToModel(Long.MAX_VALUE, String.class, Locale.ENGLISH);
        Assert.assertEquals("9,223,372,036,854,775,807", str);
        str = reverseConverter.convertToModel(Long.MIN_VALUE, String.class, Locale.ENGLISH);
    ...
    public void testOutOfBoundsValueConversion() {
        ...
        long l = converter.convertToModel("9223372036854775808", Long.class, null);
        Assert.assertEquals(Long.MAX_VALUE, l);
