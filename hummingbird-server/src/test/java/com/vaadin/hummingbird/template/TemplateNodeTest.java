...
public class TemplateNodeTest {
    ...
    public void singleElementLookup() {
        ...
        Element foundDiv = templateNode.findElementById(div.getNode(), "foo")
                .get();
    ...
    public void unknownElementLookup() {
        ...
        Assert.assertEquals(Optional.empty(), templateNode.findElementById(
    ...
    public void forLoopElement() {
        ...
        Assert.assertEquals(Optional.empty(),
                templateNode.findElementById(node, "foo"));
    }
    ...
    public void elementInIncludedFile() {
        ...
        Assert.assertEquals("<span id=\"main\">Main template</span>",
                templateNode.findElementById(stateNode, "main").get()
                        .getOuterHTML());
        Assert.assertEquals("<span id=\"sub\">Sub template</span>", templateNode
                .findElementById(stateNode, "sub").get().getOuterHTML());
    }
