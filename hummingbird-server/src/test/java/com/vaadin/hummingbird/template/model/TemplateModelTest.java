...
public class TemplateModelTest {
    ...
    public void testBooleanValue() {
        ...
        Assert.assertEquals(Boolean.FALSE, model.isBoolean());

        model.setBoolean(Boolean.TRUE);

        Assert.assertEquals(Boolean.TRUE, model.isBoolean());
    ...
    public void testBooleanParseString() {
        ...
        Assert.assertEquals(Boolean.TRUE, model.isBooleanPrimitive());
        Assert.assertEquals(Boolean.TRUE, model.isBoolean());

        template.getElement().getNode().getFeature(ModelMap.class)
                .setValue("boolean", "fALSe");
        template.getElement().getNode().getFeature(ModelMap.class)
                .setValue("booleanPrimitive", "FALSE");
