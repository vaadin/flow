...
public class JsonCodecTest {
    ...
    public void decodeAs_booleanJson() {
        ...
        Assert.assertEquals(1, JsonCodec.decodeAs(json, Integer.class));
    ...
    public void decodeAs_stringJson() {
        ...
        Assert.assertEquals(0, JsonCodec.decodeAs(json, Integer.class));
    ...
    public void decodeAs_numberJson() {
        ...
        Assert.assertEquals(15, JsonCodec.decodeAs(json, Integer.class));
