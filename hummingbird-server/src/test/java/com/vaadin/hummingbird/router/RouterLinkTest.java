...
public class RouterLinkTest {
    ...
    public void buildUrlWithParameters() {
        String url = RouterLink.buildUrl("{foo}/bar/*", "param1", "param2");

        Assert.assertEquals("param1/bar/param2", url);
    }
    ...
    @Test
    public void buildUrlWithRotuer() {
    ...
    public void createRouterLink() {
        ...
        Assert.assertTrue(link.getElement().hasAttribute("routerLink"));
    ...
    @Test
    public void createReconfigureRotuerLink() {
        RouterTestUI ui = new RouterTestUI();
        ui.getRouter().get()
                .reconfigure(c -> c.setRoute("show/{bar}", TestView.class));
