...
public class ReconnectDialogConfigurationNamespaceTest {
    ...
    protected static void testString(MapNamespace namespace, String key,
    ...
    protected static void testInt(MapNamespace namespace, String key,
    ...
    protected static void testBoolean(MapNamespace namespace, String key,
