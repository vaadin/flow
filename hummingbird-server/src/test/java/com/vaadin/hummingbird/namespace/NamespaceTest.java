...
public class NamespaceTest {
    ...
    public void testGetIdValues() {
        ...
        expectedIds.put(PropertyStreamResourceNamespace.class,
                Namespaces.STREAM_RESOURCE_PROPERTIES);
        expectedIds.put(AttributeStreamResourceNamespace.class,
                Namespaces.STREAM_RESOURCE_ATTRIBUTES);
