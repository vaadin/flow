...
public class ComponentEventBusUtilTest {
    ...
    public void domEvent_innerEventClass() {
        try {
            ...
            Assert.assertEquals(
                    "Cannot instantiate 'com.vaadin.hummingbird.event.ComponentEventBusUtilTest$InnerClass'. "
    ...
    public void domEvent_localEventClass() {
        ...
        try {
            ...
            Assert.assertEquals(
                    "Cannot instantiate local class 'com.vaadin.hummingbird.event.ComponentEventBusUtilTest$1LocalClass'. "
