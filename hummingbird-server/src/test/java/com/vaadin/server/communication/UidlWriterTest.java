...
public class UidlWriterTest {
    ...
    public void testEncodeExecuteJavaScript() {
        ...
        JsonArray expectedJson = JsonUtil.createArray(
                JsonUtil.createArray(Json.create("$0.focus()"),
                        Json.createNull()), // null since element is detached
                JsonUtil.createArray(Json.create("console.log($0, $1)"),
                        Json.create("Lives remaining:"), Json.create(3)));
