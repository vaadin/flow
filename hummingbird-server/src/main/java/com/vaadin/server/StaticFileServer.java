...
public class StaticFileServer {
    ...
    public boolean isStaticResourceRequest(HttpServletRequest request) {
        ...
        try {
            resource = request.getServletContext()
                    .getResource(request.getRequestURI());
    ...
    protected boolean acceptsGzippedResource(HttpServletRequest request) {
        ...
        if (accept.contains("gzip;q=0")) {
            return false;
        } else if (accept.contains("gzip")) {
            return true;
        } else if (accept.contains("*;q=0")) {
            return false;
    ...
    /**
     * Gest the defined resource cache time.
     *
     * Resource cache time can be defined using the
     * {@value Constants.SERVLET_PARAMETER_RESOURCE_CACHE_TIME} init parameter.
     *
     * @return the resource cache time in seconds, by default 3600s.
     */
