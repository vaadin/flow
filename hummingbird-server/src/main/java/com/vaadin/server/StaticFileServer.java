...
public class StaticFileServer {
    ...
    public boolean serveStaticResource(HttpServletRequest request,
        ...
        // There is a resource!
        long timestamp = writeModificationTimestamp(filenameWithPath,
                resourceUrl, request, response);
     ...
     */
    protected long writeModificationTimestamp(String filenameWithPath,
    ...
    private boolean isQZero(String acceptEncoding, String encoding) {
        ...
        return qValue.equals("0") || qValue.equals("0.0")
                || qValue.equals("0.00") || qValue.equals("0.000");
    }
