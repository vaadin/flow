...
public class VaadinServlet extends HttpServlet implements Constants {
    ...
    public void init(javax.servlet.ServletConfig servletConfig)
        ...
        if (initParameters
                .containsKey(Constants.SERVLET_PARAMETER_RESOURCE_CACHE_TIME)) {
            try {
                staticFileServer.setResourceCacheTime(
                        Integer.parseInt((String) initParameters.get(
                                Constants.SERVLET_PARAMETER_RESOURCE_CACHE_TIME)));
            } catch (Exception e) {
                getLogger().log(Level.SEVERE,
                        "Unable to set resource cache time to " + initParameters
                                .get(Constants.SERVLET_PARAMETER_RESOURCE_CACHE_TIME),
                        e);
            }
        }
