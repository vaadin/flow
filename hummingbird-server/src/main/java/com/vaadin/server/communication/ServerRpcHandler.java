...
public class ServerRpcHandler implements Serializable {
    ...
    private static final HashMap<String, RpcInvocationHandler> HANDLERS = loadHandlers()
            ...
            .collect(Collectors.toMap(RpcInvocationHandler::getRpcType,
                    Function.identity(), ServerRpcHandler::merge,
                    HashMap::new));
    ...
    private void handleInvocations(UI ui, int lastSyncIdSeenByClient,
        ...
        data.forEach(object -> handleInvocationData(ui, object));
    }
    ...
    private static RpcInvocationHandler merge(RpcInvocationHandler handler1,
