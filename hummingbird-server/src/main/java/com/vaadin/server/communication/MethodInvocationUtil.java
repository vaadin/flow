...
/**
 * Utility class for invoking methods with correct data types converted from
 * gotten JsonArray.
 *
 * @author Vaadin Ltd
 */
public final class MethodInvocationUtil {
     ...
     * @param args
     *            Arguments to convert and invoke method with
     */
    public static void invokeMethod(Component instance, Class<?> clazz,
