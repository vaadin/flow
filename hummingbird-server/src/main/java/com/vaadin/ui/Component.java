 ...
 * {@link #getElement()}, once the element is set. The element must be set after
 * the constructor has been invoked and the element must not change during the
...
public interface Component extends Serializable {
    ...
    default Stream<Component> getChildren() {
        ...
        getElement().getChildren().forEach(childElement -> {
            ComponentUtil.findComponents(childElement, childComponents);
        });
