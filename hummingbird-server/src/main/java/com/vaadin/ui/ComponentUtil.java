...
public interface ComponentUtil {
    ...
    /**
     * Handles triggering the {@link Component#onAttach()} and firing the
     * {@link AttachEvent} for the given component when it has been attached to
     * a UI.
     *
     * @param component
    ...
    /**
     * Handles triggering the {@link Component#onDetach()} and firing the
     * {@link DetachEvent} for the given component when it has been detached to
     * a UI.
     *
     * @param component
     *            the component detached to a UI
     */
