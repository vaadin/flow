 ...
 * browser window which points to e.g. {@link VaadinServlet}, all UIs mapped to
 * the servlet are searched for the UI class that should be opened. The
 * selection is based on the <code>UI</code> init parameter.
 * </p>
 * <p>
