...
public final class PropertyDescriptors {
    ...
    /**
     * Creates a new descriptor from a huge pile of callbacks.
     *
     * @param name
     *            the name to show in error messages, not <code>null</code>
     * @param defaultValue
     *            the default value, not <code>null</code>
     * @param setter
     *            a callback for storing a value in the component's element, not
     *            <code>null</code>
     * @param remover
     *            a callback for removing a value from the component's element,
     *            not <code>null</code>
     * @param getter
     *            a callback for storing a value in the component's element, not
     *            <code>null</code>
     * @param returnWrapper
     *            a callback for wrapping the return value of the element
     *            getter, not <code>null</code>
     *
     * @return a property descriptor, not <code>null</code>
     */
    private static <S, G> PropertyDescriptor<S, G> create(String name,
            S defaultValue, BiConsumer<Element, S> setter,
            Consumer<Element> remover, Function<Element, S> getter,
        ...
        return new PropertyDescriptor<S, G>() {
            @Override
