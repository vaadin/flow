...
public class StateNode implements Serializable {
    ...
    private UI getUI() {
        ...
        NodeOwner owner = getOwner();
        assert owner instanceof StateTree : "Attach should only be called when the node has been attached to the tree, not to a null owner";
