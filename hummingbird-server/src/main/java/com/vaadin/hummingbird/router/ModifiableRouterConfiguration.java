...
public class ModifiableRouterConfiguration
    ...
    /**
     * Set the view type and immediate parent view type to use for the given
     * path. The parent view type will be (recursively) nested in further parent
     * view types as set by {@link #setParentView(Class, Class)}.
     * <p>
     * See {@link #setRoute(String, NavigationHandler)} for a description of the
    ...
    public void setRoute(String path, Class<? extends View> viewType,
        ...
        setRoute(path, new NavigationHandler() {
            @Override
    ...
    /**
     * Set the view type to use for the given path. The view type will be
     * (recursively) nested in parent view types as set by
     * {@link #setRoute(String, Class)}.
     * <p>
     * See {@link #setRoute(String, NavigationHandler)} for a description of the
     * supported path formats.
     *
    ...
    /**
     * Sets the parent view type that should be used together with the view
     * types configured using {@link #setRoute(String, Class)} or
     * {@link #setRoute(String, Class, Class)} .
     *
     * @param viewType
