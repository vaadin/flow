 ...
 * @author Vaadin Ltd
 */
public class ViewLocationChangeEvent extends EventObject {
    ...
    /**
     * Creates a new view location change event.
     *
     * @param router
     ...
     */
    public ViewLocationChangeEvent(Router router, RouterUI ui,
