...
public class Router implements Serializable {
     ...
     */
    private final Lock configurationUpdateLock = new ReentrantLock(true);
    ...
    /**
     * Gets the currently used router configuration. This method returns a copy
     * of the configuration to prevent race conditions.
     *
