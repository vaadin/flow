...
public class RouterConfiguration
    ...
    public NavigationHandler resolveRoute(Location location) {
        ...
        // Start the recursion
        NavigationHandler navigationHandler = resolveRoute(routeTreeRoot,
                location);

        // show error view if present
        if (navigationHandler == null && errorView != null) {
            navigationHandler = new StaticViewRenderer(errorView,
                    getParentViewsAsList(errorView));
        }
    ...
    @Override
    public Optional<Class<? extends View>> getErrorView() {
