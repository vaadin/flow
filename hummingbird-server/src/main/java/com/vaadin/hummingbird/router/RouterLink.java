...
public class RouterLink extends Component implements HasText, HasComponents {
    ...
    /**
     * Creates a new router link with a text and a route. The provided
     * parameters are used to populate placeholder and wildcard slots in the
     * route, starting from the beginning of the route. The number of parameters
     * must match the number of slots in the route.
     *
     * @param text
     *            the link text
     * @param viewType
