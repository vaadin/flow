...
public class ParentGeneratorHolder extends ServerSideFeature {
    ...
    private GeneratorTemplateNode parentTemplate;
     ...
     *            previous generator
     */
    public void setParentGenerator(GeneratorTemplateNode parentTemplate) {
     ...
     */
    public Optional<GeneratorTemplateNode> getParentGenerator() {
