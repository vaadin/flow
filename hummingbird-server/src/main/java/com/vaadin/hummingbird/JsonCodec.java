...
public class JsonCodec {
     ...
     * methods supports {@link ConstantPoolReference} in addition to the types
     * supported by {@link #encodeWithConstantPool(Object, ConstantPool)}.
     *
     * @param value
     *            the value to encode
     * @param constantPool
    ...
    public static JsonValue encodeWithConstantPool(Object value,
        ...
        if (value instanceof ConstantPoolReference<?>) {
            ConstantPoolReference<?> reference = (ConstantPoolReference<?>) value;
