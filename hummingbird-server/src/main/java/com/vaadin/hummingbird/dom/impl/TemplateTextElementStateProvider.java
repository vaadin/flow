...
public class TemplateTextElementStateProvider
    ...
    private final TextTemplateNode template;
     ...
     */
    public TemplateTextElementStateProvider(TextTemplateNode template) {
    ...
    public String getTextContent(StateNode node) {
        return template.getTextBinding().getValue(node, "");
    }
    ...
    public Element getParent(StateNode node) {
        return TemplateElementStateProvider.getParent(node, template);
    }
