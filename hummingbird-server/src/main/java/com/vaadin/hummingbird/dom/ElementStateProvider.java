...
public interface ElementStateProvider extends Serializable {
    ...
    /**
     * Removes a mapping between the element and the given component.
     *
     * @param node
     *            the node containing the data
     * @param component
     *            the component the element is mapped to
     */
    void detachComponent(StateNode node, Component component);
