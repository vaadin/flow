...
public class Element implements Serializable {
     ...
     * <p>
     * Note that setting the attributes <code>style</code> or <code>class</code>
     * will override anything that has been set previously for the corresponding
     * properties via {@link #getStyle()} or {@link #getClassList()}
     * respectively.
     * <p>
