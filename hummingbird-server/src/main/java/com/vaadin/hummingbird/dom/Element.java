...
public class Element implements Serializable {
    ...
    /**
     * Sets the given property to the given JSON value. Please not that this
    ...
    public boolean getProperty(String name, boolean defaultValue) {
        ...
        if (value == null) {
            ...
            // Same logic as in JreJsonNumber.asBoolean
            return !Double.isNaN(number) && Math.abs(number) != 0.0;
    ...
    /**
     * Gets the value of the given attribute as an integer.
     * <p>
     ...
     * {@link JsonValue}. <code>null</code> is returned there is no property
    ...
    public Element removeProperty(String name) {
        ...
        stateProvider.removeValue(node, name);
        return this;
    }
