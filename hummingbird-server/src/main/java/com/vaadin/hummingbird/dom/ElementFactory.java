...
public interface ElementFactory {
     ...
     */
    public static Element createHorizontalRule() {
     ...
     */
    public static Element createParagraph() {
     ...
     * @return a {@code &lt;p>} element.
     */
    public static Element createParagraph(String textContent) {
     ...
     */
    public static Element createPreformatted() {
     ...
     * @return a {@code &lt;pre>} element.
     */
    public static Element createPreformatted(String textContent) {
