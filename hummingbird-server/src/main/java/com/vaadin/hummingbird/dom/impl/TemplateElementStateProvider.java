...
public class TemplateElementStateProvider implements ElementStateProvider {
    ...
    private ElementTemplateNode template;
     ...
     */
    public TemplateElementStateProvider(ElementTemplateNode template) {
    ...
    public Element getParent(StateNode node) {
        ...
        return getParent(node, template);
    }
     ...
     */
    public static Element getParent(StateNode node, TemplateNode template) {
        assert node != null;
        assert template != null;

        TemplateNode parentTemplate = template.getParent();
        if (parentTemplate == null) {
            ...
            return Element.get(node, parentTemplate.getStateProvider());
        }
    }

    @Override
    public int getChildCount(StateNode node) {
        return template.getChildCount();
    }
    ...
    public Element getChild(StateNode node, int index) {
        ...
        TemplateNode childTemplate = template.getChild(index);
