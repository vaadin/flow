...
/**
 * Namespace containing methods for mapping to components.
 *
 * @author Vaadin
 * @since
 */
public abstract class AbstractComponentMappingNamespace extends MapNamespace {
     ...
     */
    protected AbstractComponentMappingNamespace(StateNode node) {
        super(node);
    }
