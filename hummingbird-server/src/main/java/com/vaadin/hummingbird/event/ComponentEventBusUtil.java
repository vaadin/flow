...
public class ComponentEventBusUtil {
    ...
    public static LinkedHashMap<String, Class<?>> getEventDataExpressions(
        ...
        return cache.getDataExpressions(eventType)
                .orElse(cache.setDataExpressions(eventType,
     ...
     */
    public static LinkedHashMap<String, Class<?>> findEventDataExpressions(
            Class<? extends ComponentEvent> eventType) {
    ...
    public static <T extends ComponentEvent> Constructor<T> getEventConstructor(
        ...
        return cache.getEventConstructor(eventType)
                .orElse(cache.setEventConstructor(eventType,
    ...
    public static <T extends ComponentEvent> Constructor<T> findEventConstructor(
            Class<T> eventType) {
        ...
        if (moreThanTwoParamConstructor != null) {
            return moreThanTwoParamConstructor;
        } else if (twoParamConstructor != null) {
            return twoParamConstructor;
        } else {
            throw new IllegalArgumentException(String
                    .format(NO_SUITABLE_CONSTRUCTOR, eventType.getName()));
        }
