...
public final class SerializableJson implements Serializable {
     ...
     * <p>
     * This method is defined to return the implementation type {@link HashMap}
     * since the {@link Map} interface is not {@link Serializable}.
     *
     * @param map
     *            the map to make serializable
     * @return a new serializable map
     */
    public static <K> HashMap<K, Object> createSerializableMap(
            Map<K, Object> map) {
