...
public class BeanModelType<T> extends ModelType {
    ...
    private static class PropertyMapBuilder {
        private static Function<Method, Predicate<String>> emptyFilterProvider = method -> name -> true;

        private final Map<String, ModelType> properties = new HashMap<>();
        private PropertyFilter propertyFilter;

        public PropertyMapBuilder(PropertyFilter propertyFilter) {
