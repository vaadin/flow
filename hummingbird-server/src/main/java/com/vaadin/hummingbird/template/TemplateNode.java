...
public abstract class TemplateNode implements Serializable {
    ...
    /**
     * Sets the parent of this node. The parent should be set before the node is
     * used. The parent can only be set once.
     *
     * @param parent
     *            the parent node to set, not <code>null</code>
     */
    void setParent(TemplateNode parent) {
