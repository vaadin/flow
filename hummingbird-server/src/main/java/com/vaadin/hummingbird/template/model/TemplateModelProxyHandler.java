...
/**
 * Invocation handler for {@link TemplateModel} proxy object.
 *
 * @author Vaadin Ltd
 */
public class TemplateModelProxyHandler implements InvocationHandler {
    ...
    /**
     * Creates a proxy object of type {@link TemplateModelProxyHandler} between
     * the given template model and the given template state node.
     *
     * @param stateNode
    ...
    private Object handleObjectMethod(Method method, Object[] args) {
        ...
        case "toString":
            assert args == null;
            return "Model for " + stateNode.getId();
        default:
            throw new UnsupportedOperationException(
                    "Template Model does not yet support: " + method);
        }
    }
