 ...
 * @author Vaadin Ltd
 */
public class ChildSlotNode extends GeneratorTemplateNode {
    /**
     ...
     */
    public ChildSlotNode(TemplateNode parent) {
        super(parent);
    ...
    public Element getParent(StateNode node) {
        ...
        return Element.get(templateStateNode,
                parentTemplateNode.getStateProvider());
    }
