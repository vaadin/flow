...
public class TemplateModelUtil {
    ...
    public static class ModelPathResolver {
        ...
        /**
         * Resolves the model path starting from the given stateNode. Returns
         * the {@link ModelMap} which contains the property defined by the path,
         * i.e. uses all parts up until the last "." in the path.
         *
         * @param stateNode
        ...
        /**
         * Finds a child node with the given name (one part of a model path)
         * inside the given parent node.
         * <p>
         * Creates a new node with with the given feature if no node is found or
         * if a node is found but it does not have the correct feature.
         *
         * @param parentNode
        ...
        public static StateNode resolveStateNode(StateNode parentNode,
            ...
            if (parentLevel.hasValue(childNodeName)) {
                ...
                if (value instanceof StateNode
                    ...
                    // just override
                    return createSubModel(parentLevel, childNodeName,
                            childFeature);
                }
            } else {
