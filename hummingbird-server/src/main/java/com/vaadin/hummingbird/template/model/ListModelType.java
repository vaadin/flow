 ...
 */
public class ListModelType<T> extends ModelType {
    ...
    @Override
    public List<T> modelToUser(Serializable modelValue) {
    ...
    public void importBeans(ModelList modelList, List<T> beans,
        ...
        for (Object bean : beans) {
            StateNode childNode = itemType.userToModel(bean, propertyFilter);
