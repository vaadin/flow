(function() {
	...
	window.hummingbird = window.hummingbird || {
		initApplication: function(appId, config) {
			var testbenchId = appId.replace(/-\d+$/, '');
			
			if (apps[appId]) {
				if (window.hummingbird && window.hummingbird.clients && window.hummingbird.clients[testbenchId] && window.hummingbird.clients[testbenchId].initializing) {
			...
			window.hummingbird.clients[testbenchId] = {
					isActive: function() {
						return true;
					},
					initializing: true
	...
	log('Hummingbird bootstrap loaded');
	...
	hummingbird.initApplication("{{APP_ID}}", config);	
})();
