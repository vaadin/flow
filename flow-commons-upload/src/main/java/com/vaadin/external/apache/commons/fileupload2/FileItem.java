 ...
 * se (to avoid a seldom used dependency), several of the defined methods are
...
public interface FileItem extends FileItemHeadersSupport {
    ...
    /**
     * Returns the content type passed by the browser or {@code null} if not
     * defined.
     *
    ...
    /**
     * Returns the original file name in the client's file system, as provided
